   ...
   , TS24301IE_UENetworkCapability* pvalue)
{
   ...
   if (pvalue->m.octet10Present) {
      ...
      ret = rtxEncBits (pctxt, pvalue->octet10.spare, 6);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_RemoteUECtxt* pvalue)
{
   ...
   /* encode userIdentLength */

   RTXCTXTPUSHELEMNAME (pctxt, "userIdentLength");
   RTDIAG_NEWBITFIELD (pctxt, "INTEGER");

   ret = rtxEncUInt32 (pctxt, pvalue->userIdentLength, 1);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   RTXCTXTPUSHELEMNAME (pctxt, "userIdents");
   {
      ...
      for (i = 0; i < pvalue->userIdents.n; i++) {
         ...
         ret = rtxEncUInt32 (pctxt, pvalue->userIdents.elem[i].numocts, 1);
         if (ret < 0) return LOG_RTERR (pctxt, ret);

         ret = rtxEncBitsFromByteArray (pctxt, pvalue->userIdents.elem[i].data, pvalue->userIdents.elem[i].numocts * 8);
   ...
   , TS24301IE_RemoteUECtxtList* pvalue)
{
   ...
   ret = NASEnc_TS24301IE_RemoteUECtxtList_addrInfo (pctxt, &pvalue->addrInfo
      );
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_PKMFAddressType* pvalue)
{
   ...
   ret = rtxEncBits (pctxt, pvalue->addrType, 3);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_PKMFAddress* pvalue)
{
   ...
   {
      OSUINT8 i;
      for (i = 0; i < pvalue->addrs.n; i++) {
         RTXCTXTPUSHARRAYELEMNAME (pctxt, "elem", i);

         ret = NASEnc_TS24301IE_PKMFAddressType (pctxt, &pvalue->addrs.elem[i]
            );
         if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_HdrCompressConfig* pvalue)
{
   ...
   ret = rtxEncUInt32 (pctxt, pvalue->addlSetupType.numocts, 1);
   if (ret < 0) return LOG_RTERR (pctxt, ret);

   ret = rtxEncBitsFromByteArray (pctxt, pvalue->addlSetupType.data, pvalue->addlSetupType.numocts * 8);
   ...
   ret = NASEnc_TS24301IE_HdrCompressConfig_addlSetupContainer (pctxt, &pvalue
      ->addlSetupContainer);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
