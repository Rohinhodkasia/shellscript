               ...
               if (lastRow <= 17) {
                  ...
                  switch (pvalue->containerType)
                  {
                     ...
                     case 5:
                        ...
                        ret = NASDec_TS24501Msg_OpaqueData (pctxt, &pvalue->
...
/* begin custom source file TS24501MsgDec_RejectedNSSAI.c */
...
/* end custom source file TS24501MsgDec_RejectedNSSAI.c */
...
EXTERN int NASDec_TS24501Msg_LADN (OSCTXT* pctxt, TS24501Msg_LADN* pvalue)
{
   ...
   ret = NASDec_TS24501Msg_TrackingAreaIdentList (pctxt, &pvalue->tai);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24501Msg_SORTransparentContainer_steeringOrAck* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      case 1:
         ...
         ret = NASDec_TS24501Msg_SORSteering (pctxt, &pvalue->u.steering);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 2:
         ...
         ret = NASDec_TS24501Msg_SORAck (pctxt, &pvalue->u.ack);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
...
/* begin custom source file TS24501MsgDec_SORTransparentContainer.c */
   ...
   TS24501Msg_SORTransparentContainer* pvalue)
{
   ...
   if ((firstOctet & 1) == 0) {
      ...
      ret = NASDec_TS24501Msg_SORSteering (pctxt, &pvalue->steeringOrAck.u.steering);
      if (ret < 0) return LOG_RTERR (pctxt, ret);

   }
   else {
      pvalue->steeringOrAck.t = T_SORTransparentContainer_steeringOrAck_ack;
      ret = NASDec_TS24501Msg_SORAck (pctxt, &pvalue->steeringOrAck.u.ack);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   }
...
/* end custom source file TS24501MsgDec_SORTransparentContainer.c */
   ...
   , TS24501Msg_RequestType* pvalue)
{
   ...
   ret = NASDec_TS24501Msg_RequestTypes (pctxt, &pvalue->reqType);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24501Msg_ULNASTrans* pvalue)
{
   ...
   switch (pvalue->containerType)
   {
      ...
      case 1:
         ...
         ret = NASDec_TS24501Msg_OpaqueData (pctxt, &pvalue->container.u.n1sm
            );
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 2:
         ...
         ret = NASDec_TS24501Msg_OpaqueData (pctxt, &pvalue->container.u.sms);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 3:
         ...
         ret = NASDec_TS24501Msg_OpaqueData (pctxt, &pvalue->container.u.lpp);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 4:
         ...
         ret = NASDec_TS24501Msg_SORAck (pctxt, &pvalue->container.u.sor);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 5:
         ...
         ret = NASDec_TS24501Msg_OpaqueData (pctxt, &pvalue->container.
            u.uePolicy);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 15:
         ...
         ret = NASDec_TS24501Msg_MultiPayloadContainer (pctxt, &pvalue->
   ...
   , TS24501Msg_UEParamUpdate* pvalue)
{
   ...
   RTXCTXTPUSHELEMNAME (pctxt, "updateList");
    ...
    {
      OSRTDList tmplist;
      TS24501Msg_UEParamUpdateDataSet* pdata;

      tmplist.head = tmplist.tail = (OSRTDListNode*) 0;
      tmplist.count = 0;

      while (rtxCtxtContainerHasRemBits(pctxt)) {
         pdata = rtxMemAllocType (pctxt, TS24501Msg_UEParamUpdateDataSet);

         if (pdata == NULL)
            return LOG_RTERR (pctxt, RTERR_NOMEM);

         asn1Init_TS24501Msg_UEParamUpdateDataSet (pdata);

         RTXCTXTPUSHARRAYELEMNAME (pctxt, "elem", (OSUINT8)tmplist.count);

         ret = NASDec_TS24501Msg_UEParamUpdateDataSet (pctxt, pdata);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDListToArray (pctxt, &tmplist,
         ...
         sizeof(TS24501Msg_UEParamUpdateDataSet));
   ...
   , TS24501Msg_DLNASTrans* pvalue)
{
   ...
   switch (pvalue->containerType)
   {
      ...
      case 4:
         ...
         ret = NASDec_TS24501Msg_SORSteering (pctxt, &pvalue->container.u.sor
            );
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 6:
         ...
         ret = NASDec_TS24501Msg_UEParamUpdate (pctxt, &pvalue->container.
            u.ueParamUpdate);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24501Msg_IntegrityProtMaxDataRate* pvalue)
{
   ...
   ret = NASDec_TS24501Msg_MaxDataRates (pctxt, &pvalue->maxUEDataRateUplink);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   ret = NASDec_TS24501Msg_MaxDataRates (pctxt, &pvalue->maxUEDataRateDownlink
      );
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24501Msg_SessionAMBR* pvalue)
{
   ...
   ret = NASDec_TS24501Msg_SessionUnits (pctxt, &pvalue->unitAmbrDL);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   ret = NASDec_TS24501Msg_SessionUnits (pctxt, &pvalue->unitAmbrUL);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24501Msg_QOSFlowDescription* pvalue)
{
   ...
   ret = NASDec_TS24501Msg_FlowOpCodes (pctxt, &pvalue->opCode);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
               ...
               if (lastRow <= 1) {
                  ...
                  switch (pvalue->containerType)
                  {
                     ...
                     case 15:
                        ...
                        ret = NASDec_TS24501Msg_MultiPayloadContainer (pctxt, &
                           pvalue->container.u.multiple);
                        if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24501Msg_UEParamUpdateContainer_updateOrAck* pvalue)
{
   ...
   switch (pvalue->t)
   {
      ...
      case 1:
         ...
         ret = NASDec_TS24501Msg_UEParamUpdate (pctxt, &pvalue->u.update);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 2:
         ...
         ret = NASDec_TS24501Msg_UEParamUpdateAck (pctxt, &pvalue->u.ack);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
...
/* begin custom source file TS24501MsgDec_UEParamUpdateContainer.c */
   ...
   TS24501Msg_UEParamUpdateContainer* pvalue)
{
   ...
   if ((firstOctet & 1) == 0) {
      ...
      ret = NASDec_TS24501Msg_UEParamUpdate (pctxt, &pvalue->updateOrAck.u.update);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   }
   else {
      pvalue->updateOrAck.t = T_UEParamUpdateContainer_updateOrAck_ack;
      ret = NASDec_TS24501Msg_UEParamUpdateAck (pctxt, &pvalue->updateOrAck.u.ack);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   }
...
/* end custom source file TS24501MsgDec_UEParamUpdateContainer.c */
