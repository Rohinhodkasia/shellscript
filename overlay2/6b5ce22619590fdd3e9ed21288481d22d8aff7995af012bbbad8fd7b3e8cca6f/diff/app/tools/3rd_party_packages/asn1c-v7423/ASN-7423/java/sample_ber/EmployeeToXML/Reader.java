package sample_ber.EmployeeToXML;
...
public class Reader {
   public static void main (String args[]) {
       String filename = new String ("message.ber");
       boolean trace = true;
      ...
      try {
          ...
          // Create an XML message buffer object and encode record as XML
          ...
          encodeBuffer.write (new FileOutputStream ("message.xml"));
      }
      catch (Exception e) {
