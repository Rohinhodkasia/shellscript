package sample_xml.EmployeeXsd;
...
public class Writer {
   public static void main (String args[]) {
      ...
      personnelRecord.floor = new FloorValue(10);
      personnelRecord.age = new Asn1Integer(24);
      ...
      personnelRecord.rankings = new Asn1Integer[2];
      personnelRecord.rankings[0] = new Asn1Integer(10);
      personnelRecord.rankings[1] = new Asn1Integer(1001);
