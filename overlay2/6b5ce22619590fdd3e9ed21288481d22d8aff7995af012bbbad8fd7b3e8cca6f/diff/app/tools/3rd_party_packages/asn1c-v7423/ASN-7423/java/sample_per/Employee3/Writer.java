...
public class Writer {
   public static void main (String args[]) {
      ...
      personnelRecord.children.elements[0] =
          new ChildInformation (new Name ("Ralph", "T", "Smith"), 
                                new Date ("19571111"), null);

      personnelRecord.children.elements[1] =
          new ChildInformation (new Name ("Susan", "B", "Jones"), 
                                new Date ("19590717"), 
                                ChildInformation_sex.female());
