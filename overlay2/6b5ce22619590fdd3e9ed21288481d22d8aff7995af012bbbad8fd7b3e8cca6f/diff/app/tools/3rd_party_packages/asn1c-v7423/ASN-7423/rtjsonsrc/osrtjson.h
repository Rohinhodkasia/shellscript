 ...
 * @param pctxt        Pointer to context block structure.
 */
EXTERNJSON void rtJsonEncDecrIndent(OSCTXT* pctxt);
 ...
 * @param pctxt        Pointer to context block structure.
 */
EXTERNJSON void rtJsonEncIncrIndent(OSCTXT* pctxt);
 ...
 * @param pctxt        Pointer to context block structure.
 */
EXTERNJSON void rtJsonEncResetIndent(OSCTXT* pctxt);
 ...
 * @param pctxt        Pointer to context block structure.
 */
EXTERNJSON size_t rtJsonGetIndentLevels(OSCTXT* pctxt);
...
#define rtJsonDecIntSizeValue(pctxt, pvalue) rtJsonDecUInt32Value(pctxt,pvalue)
#elif defined OSSIZE_IS_64BITS
#define rtJsonDecIntSizeValue(pctxt, pvalue) rtJsonDecUInt64Value(pctxt,pvalue)
#endif
