...
public class Writer {
   public static void main (String args[]) {
      ...
      testData.iri = new Asn1OID_IRI("/books / lewis / c.s. / Mere_Christianity");
      testData.riri = new Asn1RELATIVE_OID_IRI("vegetables / green_beans");
      ...
      testData.iris = new TestType_iris(2);
      testData.iris.elements[0] = new Asn1OID_IRI("/com / objsys");
      testData.iris.elements[1] = new Asn1OID_IRI("/com / google");
      ...
      Asn1XerEncodeBuffer encodeBuffer = new Asn1XerEncodeBuffer(cxer);

      try {
         encodeBuffer.encodeStartDocument ();

         testData.encode (encodeBuffer, null);
