...
int main (int argc, char** argv)
{
   ...
   msgData.privateData.numocts = 4;
   msgData.privateData.data = (OSOCTET*) rtxMemAlloc (encodeBuffer.getCtxtPtr(), 4);
   {
      static const OSOCTET testdata[] = {
      244, 14, 127, 128 };
      OSCRTLMEMCPY ((void*) msgData.privateData.data, testdata, 4);
   }
