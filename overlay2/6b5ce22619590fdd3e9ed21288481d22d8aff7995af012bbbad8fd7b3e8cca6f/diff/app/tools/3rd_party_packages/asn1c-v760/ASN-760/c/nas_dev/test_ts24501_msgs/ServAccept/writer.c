...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_ServAccept data;
   TS24501Msg_ServAccept* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.seqNumber  = 120;
   pdu.hdrData.u.mm.secHdrType = TS24501Msg_NAS5GSecHdrType_noSec;

   asn1SetTC_TS24501Msg_PDU_obj_ServAccept5G (&ctxt, &pdu, pvalue);
   ...
   OSCRTLMEMSET(pvalue->reactivateRslt.psi.elem, 0,
                sizeof(pvalue->reactivateRslt.psi.elem));
   ...
   {
      pvalue->reactivateRslt.spare.numocts = 0;
   }
   ...
   pvalue->reactivateRsltCause.reactivateCause.elem[0].sessionId = 136;
   pvalue->reactivateRsltCause.reactivateCause.elem[0].cause = 28;
   ...
   pvalue->eapMessage.packetFormat.id = 202;
   ...
   {
      static const OSOCTET tmpdata[] = { 0x7d, 0xd4, 0x8b, 0x98 };
