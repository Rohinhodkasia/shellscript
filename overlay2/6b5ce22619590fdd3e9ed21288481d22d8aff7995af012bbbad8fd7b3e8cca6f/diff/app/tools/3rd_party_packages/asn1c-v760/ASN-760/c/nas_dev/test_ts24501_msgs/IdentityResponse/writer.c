...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_IdentityResponse data;
   TS24501Msg_IdentityResponse* pvalue = &data;
   OSCTXT	ctxt;
   ...
   asn1SetTC_TS24501Msg_PDU_obj_IdentityResponse5G (&ctxt, &pdu, pvalue);

   asn1Init_TS24501Msg_IdentityResponse (pvalue);

   pvalue->mobileId.t = T_TS24501IE_MobileIdentity_suci;
   pvalue->mobileId.u.suci.t = T_TS24501IE_MobileIdentity_suci_supiNetSpecificId;
   pvalue->mobileId.u.suci.u.supiNetSpecificId.nai.numocts = 2;
   pvalue->mobileId.u.suci.u.supiNetSpecificId.nai.data = (OSOCTET*) rtxMemAlloc(&ctxt, 2);
   {
      static const OSOCTET testdata[] = { 
      0x71, 0xad };
      OSCRTLSAFEMEMCPY ((void*)pvalue->mobileId.u.suci.u.supiNetSpecificId.nai.data, 2, testdata, 2);
   }
