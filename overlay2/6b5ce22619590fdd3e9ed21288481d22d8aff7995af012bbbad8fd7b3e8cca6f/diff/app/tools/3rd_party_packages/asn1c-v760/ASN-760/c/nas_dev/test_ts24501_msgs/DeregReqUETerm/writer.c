...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_DeregReqUETerm data;
   TS24501Msg_DeregReqUETerm* pvalue = &data;
   OSCTXT	ctxt;
   ...
   asn1SetTC_TS24501Msg_PDU_obj_DeregReqUETerm5G (&ctxt, &pdu, pvalue);
   ...
   pvalue->m.causePresent = TRUE;
   pvalue->cause = 5;

   pvalue->m.t3346Present = 1;
   pvalue->t3346.value.unit = 5;
   pvalue->t3346.value.timerValue = 21;

   pvalue->m._v16ExtPresent = TRUE;
   pvalue->m.rejectedNSSAIPresent = TRUE;
   pvalue->rejectedNSSAI.length = 0; // Calculated automatically...
   ...
   pvalue->rejectedNSSAI.rejectedNSSAI.elem[0].sst = 150;
   pvalue->rejectedNSSAI.rejectedNSSAI.elem[0].m.sdPresent = 1;
   pvalue->rejectedNSSAI.rejectedNSSAI.elem[0].sd = 65000;
