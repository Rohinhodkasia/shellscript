...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_ModifyRequest data;
   TS24501Msg_ModifyRequest* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.seqNumber  = 160;
   pdu.protoDiscr = TS24501Msg_NAS5GProtoDiscr_sessMgmt5G;
   pdu.hdrData.u.sm.pduSessIdent = TS24501Msg_PDUSessionIdentity_pduId6;
   pdu.hdrData.u.sm.procTransIdent = 125;

   asn1SetTC_TS24501Msg_PDU_obj_ModifyRequest5G (&ctxt, &pdu, pvalue);
   ...
   pvalue->maxPktFilters.maxFilters = 1244;
