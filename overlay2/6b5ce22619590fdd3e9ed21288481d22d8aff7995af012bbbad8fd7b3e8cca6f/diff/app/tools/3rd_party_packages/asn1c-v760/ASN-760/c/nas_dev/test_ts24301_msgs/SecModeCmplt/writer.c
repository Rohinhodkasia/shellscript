...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_SecModeCmplt data;
   TS24301Msg_SecModeCmplt* pvalue = &data;
   OSCTXT	ctxt;
   ...
   asn1SetTC_TS24301Msg_PDU_obj_SecModeCmplt (&ctxt, &pdu, pvalue);

   asn1Init_TS24301Msg_SecModeCmplt (pvalue);

   pvalue->m.imeisvPresent = 1;
   pvalue->imeisv.t =  1;
   rtxStrncpy (pvalue->imeisv.u.imsi, sizeof(pvalue->imeisv.u.imsi), "40211123456789", 15);
