...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_IdentityRequest data;
   TS24501Msg_IdentityRequest* pvalue = &data;
   OSCTXT	ctxt;
   ...
   asn1SetTC_TS24501Msg_PDU_obj_IdentityRequest5G (&ctxt, &pdu, pvalue);

   asn1Init_TS24501Msg_IdentityRequest (pvalue);

   pvalue->identity.spare = 0;
   pvalue->identity.typeOfIdent = TS24501IE_TypeOfIdentity_stmsi;
