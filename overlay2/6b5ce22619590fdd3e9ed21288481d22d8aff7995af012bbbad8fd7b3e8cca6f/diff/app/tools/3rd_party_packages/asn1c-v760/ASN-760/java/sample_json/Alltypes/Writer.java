 ...
 * (http://www.obj-sys.com).  Version: 6.6.A, Date: 11-Sep-2012.
 */
package sample_json.Alltypes;
...
public class Writer {
   ...
   public static void main(String args[]) {
      ...
      try {
         ...
         testData.gens = new Asn1GeneralString("C.S. Lewis");
         testData.grs = new Asn1GraphicString("The Great Divorce");
         testData.t61 = new Asn1T61String("The Last Battle");
         testData.vs = new Asn1VideotexString("The Silver Chair");
