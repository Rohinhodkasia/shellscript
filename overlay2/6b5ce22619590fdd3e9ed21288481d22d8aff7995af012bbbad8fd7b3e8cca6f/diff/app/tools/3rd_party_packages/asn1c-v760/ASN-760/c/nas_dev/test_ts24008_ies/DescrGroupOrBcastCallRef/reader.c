...
{
   TS24008IE_DescrGroupOrBcastCallRef data;
   OSCTXT	ctxt;
   OSOCTET*     msgbuf;
   ...
   ret = NASDec_TS24008IE_DescrGroupOrBcastCallRef (&ctxt, &data);
   ...
   if (0 != ret) {
      printf ("decode DescrGroupOrBcastCallRef failed; status = %d\n", ret);
      rtxErrPrint (&ctxt);
      return ret;
   }
   ...
   if (verbose) {
      ...
      asn1PrtToStrm_TS24008IE_DescrGroupOrBcastCallRef
         (&ctxt, "DescrGroupOrBcastCallRef", &data);
   }
