...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_AttachComplete data;
   TS24301Msg_AttachComplete* pvalue = &data;
   OSCTXT	ctxt;
   ...
   asn1SetTC_TS24301Msg_PDU_obj_AttachComplete (&ctxt, &pdu, pvalue);

   asn1Init_TS24301Msg_AttachComplete (pvalue);

   TS24301Msg_PDU_SM pdu_SM;
   TS24301Msg_ESMInfoResp data_SM;
   TS24301Msg_ESMInfoResp* pvalue_SM = &data_SM;
   ...
   asn1SetTC_TS24301Msg_PDU_SM_obj_ESMInfoResp(&ctxt, &pdu_SM, pvalue_SM);
   OSCRTLMEMSET(&data_SM, 0, sizeof(TS24301Msg_ESMInfoResp));

   pvalue->length = 0; /* length will be calculated */
   pvalue_SM->m.accessPointNamePresent = 1;
   const char *pName = "province1.mnc012.mcc345.gprs";
