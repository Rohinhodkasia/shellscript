...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_AuthFailure data;
   TS24501Msg_AuthFailure* pvalue = &data;
   OSCTXT	ctxt;
   ...
   asn1SetTC_TS24501Msg_PDU_obj_MMAuthFailure5G (&ctxt, &pdu, pvalue);
   ...
   pvalue->m.authFailureParamPresent = 1;
   {
      ...
      0xa9, 0xed, 0xb0, 0xce, 0x4a, 0xfa, 0xa3, 0xfa, 
      0x01, 0x0e, 0xbf, 0xad, 0x78, 0xb6 };
