...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_IdentResp data;
   TS24301Msg_IdentResp* pvalue = &data;
   OSCTXT	ctxt;
   ...
   asn1SetTC_TS24301Msg_PDU_obj_IdentResp (&ctxt, &pdu, pvalue);

   asn1Init_TS24301Msg_IdentResp (pvalue);

   pvalue->t =  3;
   rtxStrncpy(pvalue->u.imeisv, sizeof(pvalue->u.imeisv),
              "944ca09b7*2*6410", 17);
