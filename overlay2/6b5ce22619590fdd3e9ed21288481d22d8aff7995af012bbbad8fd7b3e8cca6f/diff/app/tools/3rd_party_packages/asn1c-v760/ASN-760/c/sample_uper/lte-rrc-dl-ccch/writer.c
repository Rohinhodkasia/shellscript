...
int main (int argc, char** argv)
{
   ...
   pvalue->message.u.c1->u.rrcConnectionSetup->
      criticalExtensions.u.c1->u.rrcConnectionSetup_r8->
      radioResourceConfigDedicated.physicalConfigDedicated.
      cqi_ReportConfig.cqi_ReportModeAperiodic = CQI_ReportModeAperiodic_rm22;
   ...
   pvalue->message.u.c1->u.rrcConnectionSetup->
      ...
      AntennaInfoDedicated_r10_transmissionMode_r10_tm3;
   ...
   pvalue->message.u.c1->u.rrcConnectionSetup->
      criticalExtensions.u.c1->u.rrcConnectionSetup_r8->
      radioResourceConfigDedicated.physicalConfigDedicated.antennaInfo_r10.u.
      explicitValue_r10->ue_TransmitAntennaSelection.u.setup = 
      AntennaInfoDedicated_ue_TransmitAntennaSelection_setup_openLoop;
