...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_NotifyResponse data;
   TS24501Msg_NotifyResponse* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.msgAuthCode = 8001;
   pdu.secHdr.seqNumber = 15;
   pdu.hdrData.u.mm.secHdrType = TS24501Msg_NAS5GSecHdrType_noSec;

   asn1SetTC_TS24501Msg_PDU_obj_NotifyResponse5G (&ctxt, &pdu, pvalue);
