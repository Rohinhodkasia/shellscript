...
int main (int argc, char** argv)
{
   ...
   TS24011Msg_RPDataMSTerminated data;
   OSCTXT	ctxt;
   OSOCTET*     msgbuf;
   ...
   ret = NASDec_TS24011Msg_RPDataMSTerminated (&ctxt, &data);
   if (0 != ret) {
   ...
   if (verbose) {
      ...
      asn1PrtToStrm_TS24011Msg_RPDataMSTerminated
         (&ctxt, "RPDataMSTerminated", &data);
   }
