...
public class Writer {
   public static void main (String args[]) {
      ...
      personnelRecord.children.elements[1] =
          new ChildInformation (new Name ("Susan",
/* 
   To demonstrate element tracking, replace "B", below, with "B." to cause an exception
   during the encoding.
*/
               "B",
               "Jones"), "19590717");
      ...
      Asn1Context ctxt = encodeBuffer.getContext();
      ctxt.enableElementTracking();
      ...
      try {
          ...
          System.out.println ("Current element was " + ctxt.getCurrentElement() );
          e.printStackTrace();
          System.exit(-1);
      }
   }
