...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_DeactEPSBearerCtxtAcc data;
   TS24301Msg_DeactEPSBearerCtxtAcc* pvalue = &data;
   ...
   pdu.msgType = ASN1V_ts24301Msg_mt_DeactEPSBearerCtxtAcc;
   pdu.data.t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_DeactEPSBearerCtxtAcc;
   pdu.data.u.obj_DeactEPSBearerCtxtAcc = pvalue;

   asn1Init_TS24301Msg_DeactEPSBearerCtxtAcc (pvalue);
   pvalue->m.protocolConfigOptionsPresent = 1;
   pvalue->protocolConfigOptions.length = 208;
