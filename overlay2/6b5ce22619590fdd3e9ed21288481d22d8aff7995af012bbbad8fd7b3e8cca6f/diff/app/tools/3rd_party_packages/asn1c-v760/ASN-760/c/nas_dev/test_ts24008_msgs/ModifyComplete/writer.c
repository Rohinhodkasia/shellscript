...
{
   TS24008Msg_PDU pdu;
   TS24008Msg_ModifyComplete data;
   TS24008Msg_ModifyComplete* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_mt_ModifyComplete;
   pdu.data.t = T_TS24008Msgs_TS24008_IE_OBJECTSET_obj_ModifyComplete;
   pdu.data.u.obj_ModifyComplete = pvalue;
   ...
   pvalue->highLayerComp.length = 110;
   ...
   pvalue->highLayerComp.highLayerCharacteristicsID = 83;
   pvalue->highLayerComp.m.extHighLayerCharacteristicsIDPresent = 1;
   pvalue->highLayerComp.extHighLayerCharacteristicsID = 118;
