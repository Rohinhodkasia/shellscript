...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_ActvDfltEPSBearerCtxtRej data;
   TS24301Msg_ActvDfltEPSBearerCtxtRej* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_ts24301Msg_mt_ActvDfltEPSBearerCtxtRej;
   pdu.data.t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_ActvDfltEPSBearerCtxtRej;
   pdu.data.u.obj_ActvDfltEPSBearerCtxtRej = pvalue;
   ...
   pvalue->protocolConfigOptions.length = 171;
