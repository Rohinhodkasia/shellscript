   ...
   , TS24008Msg_AttachAccept* pvalue)
{
   ...
   ret = NASDec_TS24008IE_RadioPriority2 (pctxt, &pvalue->radioPriForTOM8);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   ret = NASDec_TS24008IE_RadioPriority (pctxt, &pvalue->radioPriForSMS);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
...

   {
      ...
      while (rtxCtxtContainerHasRemBits(pctxt)) {
         ...
         nibble = iei >> 4;
         if (nibble == 11 || nibble == 10 || nibble == 12 || nibble == 13) {
            /* decode 4-bit IEI */
            pctxt->buffer.byteIndex--;
         ...
         switch (iei) {
            ...
            case 12: {
               if (lastRow <= 17) {
                  /* decode userPlaneIntegInd */
                  RTXCTXTPUSHELEMNAME (pctxt, "userPlaneIntegInd");

                  ret = NASDec_TS24008IE_UserPlaneIntegInd (pctxt, &pvalue->
                     userPlaneIntegInd);
                  if (ret < 0) return LOG_RTERR (pctxt, ret);
            ...
            case 51: {
               if (lastRow <= 19) {
                  /* decode replayMSRadioAccessCap */
                  RTXCTXTPUSHELEMNAME (pctxt, "replayMSRadioAccessCap");

                  ret = NASDec_TS24008IE_MSRadioAccessCapability (pctxt, &
                     pvalue->replayMSRadioAccessCap);
                  if (ret < 0) return LOG_RTERR (pctxt, ret);
            ...
            case 99: {
               if (lastRow <= 21) {
                  ...
                  ret = NASDec_TS24008IE_PlmnCnID (pctxt, &pvalue->plmnCnId);
                  if (ret < 0) return LOG_RTERR (pctxt, ret);
...

   {
      ...
      while (rtxCtxtContainerHasRemBits(pctxt)) {
         ...
         switch (iei) {
            ...
            case 9: {
               if (lastRow <= 4) {
                  /* decode integAlgorithm */
                  RTXCTXTPUSHELEMNAME (pctxt, "integAlgorithm");

                  ret = NASDec_TS24008IE_IntegrityAlgorithmType (pctxt, &pvalue
                     ->integAlgorithm);
                  if (ret < 0) return LOG_RTERR (pctxt, ret);
            ...
            case 67: {
               if (lastRow <= 5) {
                  ...
                  ret = NASDec_TS24008IE_MsgAuthCode (pctxt, &pvalue->
                     msgAuthCode);
                  if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008Msg_ActivatePDPCtxtAccept* pvalue)
{
   ...
   ret = NASDec_TS24008IE_RadioPriority (pctxt, &pvalue->radioPriority);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
...
EXTERN int NASDec_TS24008Msg_PDU (OSCTXT* pctxt, TS24008Msg_PDU* pvalue)
{
   ...
   /* begin custom source file TS24008MsgDec_PDU_l3HdrOpts.c */
   ...
   /* end custom source file TS24008MsgDec_PDU_l3HdrOpts.c */
   ...
   switch (pvalue->protoDiscr) {
      ...
      switch (pvalue->msgType) {
         ...
         case ASN1V_mt_AuthenticationResponse:
            ...
            pvalue->data.u.obj_AuthenticationResponse
                = rtxMemAllocType (pctxt, TS24008Msg_AuthenticationResponse);
         ...
         case ASN1V_mt_MMStatus:
            ...
            ret = NASDec_TS24008Msg_MMStatus (pctxt, pvalue->data.
               u.obj_MMStatus);
            if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         case ASN1V_mt_TMSIReallocCmd:
            ...
            asn1Init_TS24008Msg_TMSIReallocCmd (pvalue->data.
...
switch (pvalue->msgType) {
   ...
   case ASN1V_mt_AttachRequest:
      pvalue->data.t = T_TS24008Msgs_TS24008_IE_OBJECTSET_obj_AttachRequest;
   ...
   case ASN1V_mt_AttachComplete:
      pvalue->data.t = T_TS24008Msgs_TS24008_IE_OBJECTSET_obj_AttachComplete;
   ...
   case ASN1V_mt_DetachRequest:
      pvalue->data.t = T_TS24008Msgs_TS24008_IE_OBJECTSET_obj_DetachRequest;
   ...
   case ASN1V_mt_P_TMSIReallocCmd:
      ...
      asn1Init_TS24008Msg_P_TMSIReallocCmd (pvalue->data.u.obj_P_TMSIReallocCmd
         );
   ...
   case ASN1V_mt_RoutingAreaUpdateComplete:
      ...
      pvalue->data.u.obj_RoutingAreaUpdateComplete = rtxMemAllocType (pctxt, 
   ...
   case ASN1V_mt_GMMInformation:
      pvalue->data.t = T_TS24008Msgs_TS24008_IE_OBJECTSET_obj_GMMInformation;
   ...
   case ASN1V_mt_ServiceRequest:
      pvalue->data.t = T_TS24008Msgs_TS24008_IE_OBJECTSET_obj_ServiceRequest;
   ...
   case ASN1V_mt_ServiceAccept:
      pvalue->data.t = T_TS24008Msgs_TS24008_IE_OBJECTSET_obj_ServiceAccept;
   ...
   case ASN1V_mt_ServiceReject:
      pvalue->data.t = T_TS24008Msgs_TS24008_IE_OBJECTSET_obj_ServiceReject;
...
switch (pvalue->msgType) {
   ...
   case ASN1V_mt_ActivateSecondaryPDPCtxtRqst:
      ...
      pvalue->data.u.obj_ActivateSecondaryPDPCtxtRqst
          = rtxMemAllocType (pctxt, TS24008Msg_ActivateSecondaryPDPCtxtRqst);
      ...
      ret = NASDec_TS24008Msg_ActivateSecondaryPDPCtxtRqst (pctxt, pvalue->data
         .u.obj_ActivateSecondaryPDPCtxtRqst);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   case ASN1V_mt_ActivateSecondaryPDPCtxtAcc:
      ...
      pvalue->data.u.obj_ActivateSecondaryPDPCtxtAcc = rtxMemAllocType (pctxt, 
      ...
      ret = NASDec_TS24008Msg_ActivateSecondaryPDPCtxtAcc (pctxt, pvalue->data.
         u.obj_ActivateSecondaryPDPCtxtAcc);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   case ASN1V_mt_ActivateSecondaryPDPCtxtRej:
      ...
      pvalue->data.u.obj_ActivateSecondaryPDPCtxtRej = rtxMemAllocType (pctxt, 
      ...
      ret = NASDec_TS24008Msg_ActivateSecondaryPDPCtxtRej (pctxt, pvalue->data.
         u.obj_ActivateSecondaryPDPCtxtRej);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   case ASN1V_mt_ModifyPDPCtxtRej:
      ...
      asn1Init_TS24008Msg_ModifyPDPCtxtRej (pvalue->data.u.obj_ModifyPDPCtxtRej
         );
   ...
   case ASN1V_mt_RqstSecondaryPDPCtxtActRej:
      ...
      pvalue->data.u.obj_RqstSecondaryPDPCtxtActRej = rtxMemAllocType (pctxt, 
      ...
      ret = NASDec_TS24008Msg_RqstSecondaryPDPCtxtActRej (pctxt, pvalue->data.
         u.obj_RqstSecondaryPDPCtxtActRej);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   case ASN1V_mt_SMStatus:
      ...
      ret = NASDec_TS24008IE_SMCauseValue (pctxt, &pvalue->data.u.obj_SMStatus
         );
      if (ret < 0) return LOG_RTERR (pctxt, ret);
