...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_ReleaseDone data;
   TS24501Msg_ReleaseDone* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.msgAuthCode = 37000;
   pdu.secHdr.seqNumber  = 100;
   pdu.protoDiscr = TS24501Msg_NAS5GProtoDiscr_sessMgmt5G;
   pdu.hdrData.u.sm.pduSessIdent = TS24501Msg_PDUSessionIdentity_pduId11;
   pdu.hdrData.u.sm.procTransIdent = 200;

   asn1SetTC_TS24501Msg_PDU_obj_ReleaseDone5G (&ctxt, &pdu, pvalue);
