...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_EstablishReject data;
   TS24501Msg_EstablishReject* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.msgAuthCode = 40000;
   pdu.secHdr.seqNumber  = 80;
   pdu.protoDiscr = TS24501Msg_NAS5GProtoDiscr_sessMgmt5G;
   pdu.hdrData.u.sm.pduSessIdent = TS24501Msg_PDUSessionIdentity_pduId1;
   pdu.hdrData.u.sm.procTransIdent = 120;

   asn1SetTC_TS24501Msg_PDU_obj_EstablishReject5G (&ctxt, &pdu, pvalue);
   ...
   pvalue->eapMessage.packetFormat.id = 62;
   ...
   {
      static const OSOCTET tmpdata[] = { 0xad, 0xfa, 0x79, 0xe5 };
   ...
   pvalue->m.reattemptIndPresent = TRUE;
   pvalue->reattemptInd.eplmnc = TRUE;
   pvalue->reattemptInd.ratc = FALSE;
