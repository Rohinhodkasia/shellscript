...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_SMAuthResult data;
   TS24501Msg_SMAuthResult* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.seqNumber  = 150;
   pdu.protoDiscr = TS24501Msg_NAS5GProtoDiscr_sessMgmt5G;
   pdu.hdrData.u.sm.pduSessIdent = TS24501Msg_PDUSessionIdentity_pduId15;
   pdu.hdrData.u.sm.procTransIdent = 250;

   asn1SetTC_TS24501Msg_PDU_obj_SMAuthResult5G (&ctxt, &pdu, pvalue);
   ...
   {
      static const OSOCTET tmpdata[] = { 0x0e, 0x35, 0xae, 0x4e };
