 ...
 * (http://www.obj-sys.com).  Version: 6.4.A, Date: 23-Dec-2010.
 */
#include "Test.h"
...
int main (int argc, char** argv)
{
   ...
   pdata = asn1Test_SeqOfCharStr (&ctxt);

   if (trace) {
      printf ("The following record will be encoded:\n");
      asn1Print_SeqOfCharStr ("data", pdata);
      printf ("\n");
   }
   ...
   /* Encode */
   stat = OEREnc_SeqOfCharStr (&ctxt, pdata);
