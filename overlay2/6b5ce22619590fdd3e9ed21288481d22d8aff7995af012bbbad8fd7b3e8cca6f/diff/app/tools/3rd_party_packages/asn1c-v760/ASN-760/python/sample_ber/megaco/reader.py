...
# (https://obj-sys.com).  Version: 7.4.A, Date: 13-Nov-2019.
#
...
from MEDIA_GATEWAY_CONTROL import *
...
class Reader:
    ...
    def main(filename, trace):
        try:
            ...
            megacoMessage.ber_decode(decbuf)

            if trace:
                megacoMessage.print_value("megacoMessage", 0)
