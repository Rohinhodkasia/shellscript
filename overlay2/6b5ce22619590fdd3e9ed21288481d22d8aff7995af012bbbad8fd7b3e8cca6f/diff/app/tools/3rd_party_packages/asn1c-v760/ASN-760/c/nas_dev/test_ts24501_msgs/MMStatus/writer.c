...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_MMStatus data;
   TS24501Msg_MMStatus* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.msgAuthCode = 81000;
   pdu.secHdr.seqNumber = 85;
   pdu.hdrData.u.mm.secHdrType = TS24501Msg_NAS5GSecHdrType_noSec;

   asn1SetTC_TS24501Msg_PDU_obj_MMStatus5G (&ctxt, &pdu, pvalue);
