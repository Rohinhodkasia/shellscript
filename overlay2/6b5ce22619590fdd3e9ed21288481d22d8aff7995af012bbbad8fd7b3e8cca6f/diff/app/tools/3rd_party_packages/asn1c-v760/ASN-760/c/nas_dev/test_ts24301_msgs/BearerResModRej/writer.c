...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_BearerResModRej data;
   TS24301Msg_BearerResModRej* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_ts24301Msg_mt_BearerResModRej;
   pdu.data.t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_BearerResModRej;
   pdu.data.u.obj_BearerResModRej = pvalue;
   ...
   pvalue->protocolConfigOptions.length = 86;
