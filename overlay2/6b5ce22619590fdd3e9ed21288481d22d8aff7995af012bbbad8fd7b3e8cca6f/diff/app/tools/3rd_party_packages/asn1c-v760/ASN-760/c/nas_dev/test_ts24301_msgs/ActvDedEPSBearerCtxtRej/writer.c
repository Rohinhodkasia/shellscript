...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_ActvDedEPSBearerCtxtRej data;
   TS24301Msg_ActvDedEPSBearerCtxtRej* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_ts24301Msg_mt_ActvDedEPSBearerCtxtRej;
   pdu.data.t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_ActvDedEPSBearerCtxtRej;
   pdu.data.u.obj_ActvDedEPSBearerCtxtRej = pvalue;
   ...
   pvalue->protocolConfigOptions.length = 191;
