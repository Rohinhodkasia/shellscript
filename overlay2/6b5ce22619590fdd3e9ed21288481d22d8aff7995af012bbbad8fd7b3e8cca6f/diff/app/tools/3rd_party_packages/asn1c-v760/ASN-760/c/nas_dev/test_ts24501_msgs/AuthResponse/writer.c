...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_AuthResponse data;
   TS24501Msg_AuthResponse* pvalue = &data;
   OSCTXT	ctxt;
   ...
   asn1SetTC_TS24501Msg_PDU_obj_MMAuthResponse5G (&ctxt, &pdu, pvalue);

   pvalue->m.authRespParamPresent = 1;
   {
      static const OSOCTET testdata[] = { 
      0x46, 0x73, 0x28, 0x3d, 0x25, 0xff, 0x64, 0x37, 0x82, 0xd3, 0x52, 0xee, 0xdd, 0xcc, 0xbb, 0xaa };
      pvalue->authRespParam.numocts = 16;
      OSCRTLSAFEMEMCPY ((void*)pvalue->authRespParam.data, 16, testdata, 16);
   }
   ...
   pvalue->eapMessage.packetFormat.id = 123;
   ...
   {
      static const OSOCTET tmpdata[] = { 0x77, 0x5a, 0xc7, 0x21 };
