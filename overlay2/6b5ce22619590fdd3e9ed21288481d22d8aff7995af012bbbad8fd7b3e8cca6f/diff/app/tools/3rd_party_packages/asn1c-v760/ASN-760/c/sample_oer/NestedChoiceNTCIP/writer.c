...
int main (int argc, char** argv)
{
   ...
   pdata = rtxMemAllocType (&ctxt, TestChoice);
   asn1Init_TestChoice (pdata);

   pdata->t =  T_TestChoice_nest;
   pdata->u.nest = rtxMemAllocType(&ctxt, TestChoice_nest);
   pdata->u.nest->t = T_TestChoice_nest_bw_color;
   pdata->u.nest->u.bw_color = color;
   ...
   if (trace) {
      ...
      asn1Print_TestChoice ("data", pdata);
      printf ("\n");
   }
   ...
   /* Encode */
   stat = OEREnc_TestChoice (&ctxt, pdata);
