...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_SMAuthDone data;
   TS24501Msg_SMAuthDone* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.msgAuthCode = 20000;
   pdu.secHdr.seqNumber  = 250;
   pdu.protoDiscr = TS24501Msg_NAS5GProtoDiscr_sessMgmt5G;
   pdu.hdrData.u.sm.pduSessIdent = TS24501Msg_PDUSessionIdentity_pduId14;
   pdu.hdrData.u.sm.procTransIdent = 128;

   asn1SetTC_TS24501Msg_PDU_obj_SMAuthDone5G (&ctxt, &pdu, pvalue);
   ...
   pvalue->eapMessage.packetFormat.id = 255;
   ...
   {
      static const OSOCTET tmpdata[] = { 0x81, 0x74, 0xa9, 0x9e };
