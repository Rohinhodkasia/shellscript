...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_ActvDfltEPSBearerCtxtAcc data;
   TS24301Msg_ActvDfltEPSBearerCtxtAcc* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_ts24301Msg_mt_ActvDfltEPSBearerCtxtAcc;
   pdu.data.t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_ActvDfltEPSBearerCtxtAcc;
   pdu.data.u.obj_ActvDfltEPSBearerCtxtAcc = pvalue;

   asn1Init_TS24301Msg_ActvDfltEPSBearerCtxtAcc (pvalue);
   pvalue->m.protocolConfigOptionsPresent = 1;
   pvalue->protocolConfigOptions.length = 55;
