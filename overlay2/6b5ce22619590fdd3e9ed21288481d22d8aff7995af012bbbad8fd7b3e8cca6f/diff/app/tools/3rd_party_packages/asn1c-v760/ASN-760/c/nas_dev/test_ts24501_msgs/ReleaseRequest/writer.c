...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_ReleaseRequest data;
   TS24501Msg_ReleaseRequest* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.hdrData.u.sm.pduSessIdent = TS24501Msg_PDUSessionIdentity_pduId13;
   pdu.hdrData.u.sm.procTransIdent = 230;

   asn1SetTC_TS24501Msg_PDU_obj_ReleaseRequest5G (&ctxt, &pdu, pvalue);
