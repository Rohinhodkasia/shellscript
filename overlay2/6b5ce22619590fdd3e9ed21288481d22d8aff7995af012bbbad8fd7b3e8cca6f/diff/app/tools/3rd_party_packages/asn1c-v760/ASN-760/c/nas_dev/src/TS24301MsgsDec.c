   ...
   , TS24301Msg_ESMDataTransport* pvalue)
{
   ...
   ret = NASDec_TS24301IE_UserDataContainer (pctxt, &pvalue->userDataContainer
      );
   if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         switch (iei) {
            ...
            case 111: {
               if (lastRow <= 2) {
                  ...
                  ret = NASDec_TS24301IE_PKMFAddress (pctxt, &pvalue->
                     proSeKeyMgmtFunc);
                  if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   switch (pvalue->protoDiscr) {
      ...
      switch (pvalue->msgType) {
         ...
         case ASN1V_ts24301Msg_mt_ActvDedEPSBearerCtxtAcc:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ActvDedEPSBearerCtxtAcc;

            pvalue->data.u.obj_ActvDedEPSBearerCtxtAcc
                = rtxMemAllocType (pctxt, TS24301Msg_ActvDedEPSBearerCtxtAcc);
            ...
            ret = NASDec_TS24301Msg_ActvDedEPSBearerCtxtAcc (pctxt, pvalue->
               data.u.obj_ActvDedEPSBearerCtxtAcc);
            if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         case ASN1V_ts24301Msg_mt_ActvDedEPSBearerCtxtRej:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ActvDedEPSBearerCtxtRej;

            pvalue->data.u.obj_ActvDedEPSBearerCtxtRej
                = rtxMemAllocType (pctxt, TS24301Msg_ActvDedEPSBearerCtxtRej);
            ...
            ret = NASDec_TS24301Msg_ActvDedEPSBearerCtxtRej (pctxt, pvalue->
               data.u.obj_ActvDedEPSBearerCtxtRej);
            if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         case ASN1V_ts24301Msg_mt_ActvDedEPSBearerCtxtReq:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ActvDedEPSBearerCtxtReq;

            pvalue->data.u.obj_ActvDedEPSBearerCtxtReq
                = rtxMemAllocType (pctxt, TS24301Msg_ActvDedEPSBearerCtxtReq);
            ...
            ret = NASDec_TS24301Msg_ActvDedEPSBearerCtxtReq (pctxt, pvalue->
               data.u.obj_ActvDedEPSBearerCtxtReq);
            if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         case ASN1V_ts24301Msg_mt_ActvDfltEPSBearerCtxtAcc:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ActvDfltEPSBearerCtxtAcc;

            pvalue->data.u.obj_ActvDfltEPSBearerCtxtAcc
            ...
            ret = NASDec_TS24301Msg_ActvDfltEPSBearerCtxtAcc (pctxt, pvalue->
               data.u.obj_ActvDfltEPSBearerCtxtAcc);
            if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         case ASN1V_ts24301Msg_mt_ActvDfltEPSBearerCtxtRej:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ActvDfltEPSBearerCtxtRej;

            pvalue->data.u.obj_ActvDfltEPSBearerCtxtRej
                = rtxMemAllocType (pctxt, 
            ...
            ret = NASDec_TS24301Msg_ActvDfltEPSBearerCtxtRej (pctxt, pvalue->
               data.u.obj_ActvDfltEPSBearerCtxtRej);
            if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         case ASN1V_ts24301Msg_mt_ActvDfltEPSBearerCtxtReq:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ActvDfltEPSBearerCtxtReq;

            pvalue->data.u.obj_ActvDfltEPSBearerCtxtReq
                = rtxMemAllocType (pctxt, 
            ...
            ret = NASDec_TS24301Msg_ActvDfltEPSBearerCtxtReq (pctxt, pvalue->
               data.u.obj_ActvDfltEPSBearerCtxtReq);
            if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         case ASN1V_ts24301Msg_mt_BearerResAllocRej:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_BearerResAllocRej;
         ...
         case ASN1V_ts24301Msg_mt_BearerResAllocReq:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_BearerResAllocReq;
         ...
         case ASN1V_ts24301Msg_mt_BearerResModRej:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_BearerResModRej;
         ...
         case ASN1V_ts24301Msg_mt_BearerResModReq:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_BearerResModReq;
         ...
         case ASN1V_ts24301Msg_mt_DeactEPSBearerCtxtAcc:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_DeactEPSBearerCtxtAcc;
         ...
         case ASN1V_ts24301Msg_mt_DeactEPSBearerCtxtReq:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_DeactEPSBearerCtxtReq;
         ...
         case ASN1V_ts24301Msg_mt_ESMInfoReq:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ESMInfoReq;
         ...
         case ASN1V_ts24301Msg_mt_ESMInfoResp:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ESMInfoResp;
         ...
         case ASN1V_ts24301Msg_mt_ESMStatus:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ESMStatus;
         ...
         case ASN1V_ts24301Msg_mt_ModEPSBearerCtxtAcc:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ModEPSBearerCtxtAcc;
         ...
         case ASN1V_ts24301Msg_mt_ModEPSBearerCtxtRej:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ModEPSBearerCtxtRej;
         ...
         case ASN1V_ts24301Msg_mt_ModEPSBearerCtxtReq:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ModEPSBearerCtxtReq;
         ...
         case ASN1V_ts24301Msg_mt_PDNConnectRej:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_PDNConnectRej;
         ...
         case ASN1V_ts24301Msg_mt_PDNConnectReq:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_PDNConnectReq;
         ...
         case ASN1V_ts24301Msg_mt_PDNDisconnRej:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_PDNDisconnRej;
         ...
         case ASN1V_ts24301Msg_mt_PDNDisconnReq:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_PDNDisconnReq;
         ...
         case ASN1V_ts24301Msg_mt_ESMDataTransport:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_ESMDataTransport;
         ...
         /* obj_RemoteUEReport */
         case ASN1V_ts24301Msg_mt_RemoteUEReport:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_SM_OBJECTSET_obj_RemoteUEReport;

            pvalue->data.u.obj_RemoteUEReport = rtxMemAllocType (pctxt, 
               TS24301Msg_RemoteUEReport);

            if (pvalue->data.u.obj_RemoteUEReport == NULL)
               return LOG_RTERR (pctxt, RTERR_NOMEM);

            asn1Init_TS24301Msg_RemoteUEReport (pvalue->data.
               u.obj_RemoteUEReport);

            RTXCTXTPUSHELEMNAME (pctxt, "u.obj_RemoteUEReport");

            ret = NASDec_TS24301Msg_RemoteUEReport (pctxt, pvalue->data.
               u.obj_RemoteUEReport);
            if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301Msg_ESMMessageContainer* pvalue)
{
   ...
   ret = NASDec_TS24301Msg_PDU_SM (pctxt, &pvalue->pduSm);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301Msg_AttachComplete* pvalue)
{
   ...
   ret = NASDec_TS24301Msg_ESMMessageContainer (pctxt, pvalue);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         switch (iei) {
            case 101: {
               if (lastRow == 0) {
                  ...
                  ret = NASDec_TS24301Msg_GenNASTransport_addnInfo (pctxt, &
                     pvalue->addnInfo);
                  if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301Msg_Notification* pvalue)
{
   ...
   ret = NASDec_TS24301IE_NotificationIndicator (pctxt, pvalue);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
...

   {
      ...
      while (rtxCtxtContainerHasRemBits(pctxt)) {
         ...
         switch (iei) {
            ...
            case 54: {
               if (lastRow <= 24) {
                  /* decode negotiatedDRXParam */
                  RTXCTXTPUSHELEMNAME (pctxt, "negotiatedDRXParam");

                  ret = NASDec_TS24301IE_NBS1DRXParameter (pctxt, &pvalue->
                     negotiatedDRXParam);
                  if (ret < 0) return LOG_RTERR (pctxt, ret);
...

   {
      ...
      while (rtxCtxtContainerHasRemBits(pctxt)) {
         ...
         switch (iei) {
            ...
            case 52: {
               if (lastRow <= 23) {
                  /* decode ueRadioCapIdAvail */
                  RTXCTXTPUSHELEMNAME (pctxt, "ueRadioCapIdAvail");

                  ret = NASDec_TS24301IE_UERadioCapIdAvailability (pctxt, &
                     pvalue->ueRadioCapIdAvail);
                  if (ret < 0) return LOG_RTERR (pctxt, ret);
...

   {
      ...
      while (rtxCtxtContainerHasRemBits(pctxt)) {
         ...
         switch (iei) {
            ...
            case 11: {
               if (lastRow <= 3) {
                  /* decode ueRadioCapIdDelInd */
                  RTXCTXTPUSHELEMNAME (pctxt, "ueRadioCapIdDelInd");

                  ret = NASDec_TS24301IE_UERadioCapIdDeletionInd (pctxt, &
                     pvalue->ueRadioCapIdDelInd);
                  if (ret < 0) return LOG_RTERR (pctxt, ret);
...
EXTERN int NASDec_TS24301Msg_PDU (OSCTXT* pctxt, TS24301Msg_PDU* pvalue)
{
   ...
   switch (pvalue->protoDiscr) {
      ...
      switch (pvalue->msgType) {
         ...
         case ASN1V_ts24301Msg_mt_AttachAccept:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_AttachAccept;
         ...
         case ASN1V_ts24301Msg_mt_AttachComplete:
            ...
            asn1Init_TS24301Msg_AttachComplete (pvalue->data.
         ...
         case ASN1V_ts24301Msg_mt_AttachReject:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_AttachReject;
         ...
         case ASN1V_ts24301Msg_mt_AuthFailure:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_AuthFailure;
         ...
         case ASN1V_ts24301Msg_mt_AuthReject:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_AuthReject;
         ...
         case ASN1V_ts24301Msg_mt_AuthRequest:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_AuthRequest;
         ...
         case ASN1V_ts24301Msg_mt_AuthResponse:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_AuthResponse;
         ...
         case ASN1V_ts24301Msg_mt_CSServiceNotif:
            ...
            asn1Init_TS24301Msg_CSServiceNotif (pvalue->data.
         ...
         case ASN1V_ts24301Msg_mt_DetachAccept:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_DetachAccept;
         ...
         case ASN1V_ts24301Msg_mt_DLNASTransport:
            ...
            asn1Init_TS24301Msg_DLNASTransport (pvalue->data.
         ...
         case ASN1V_ts24301Msg_mt_EMMInformation:
            ...
            asn1Init_TS24301Msg_EMMInformation (pvalue->data.
         ...
         case ASN1V_ts24301Msg_mt_GUTIReallocCmd:
            ...
            asn1Init_TS24301Msg_GUTIReallocCmd (pvalue->data.
         ...
         case ASN1V_ts24301Msg_mt_IdentReq:
            ...
            ret = NASDec_TS24301Msg_IdentReq (pctxt, pvalue->data.
               u.obj_IdentReq);
            if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         case ASN1V_ts24301Msg_mt_IdentResp:
            ...
            ret = NASDec_TS24301Msg_IdentResp (pctxt, pvalue->data.
               u.obj_IdentResp);
            if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         case ASN1V_ts24301Msg_mt_SecModeCmd:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_SecModeCmd;
         ...
         case ASN1V_ts24301Msg_mt_SecModeCmplt:
            pvalue->data.
               t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_SecModeCmplt;
         ...
         case ASN1V_ts24301Msg_mt_ULNASTransport:
            ...
            asn1Init_TS24301Msg_ULNASTransport (pvalue->data.
   ...
   switch (pvalue->msgType) {
      ...
      case ASN1V_ts24301Msg_mt_RemoteUEReport:
         pvalue->data.
            t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_RemoteUEReport;
         ...
         asn1Init_TS24301Msg_RemoteUEReport (pvalue->data.u.obj_RemoteUEReport
            );
