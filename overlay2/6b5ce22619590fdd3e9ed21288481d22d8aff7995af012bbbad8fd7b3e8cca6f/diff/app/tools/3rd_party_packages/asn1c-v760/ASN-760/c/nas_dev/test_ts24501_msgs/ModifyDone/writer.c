...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_ModifyDone data;
   TS24501Msg_ModifyDone* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.hdrData.u.sm.pduSessIdent = TS24501Msg_PDUSessionIdentity_pduId4;
   pdu.hdrData.u.sm.procTransIdent = 230;

   asn1SetTC_TS24501Msg_PDU_obj_ModifyDone5G (&ctxt, &pdu, pvalue);
