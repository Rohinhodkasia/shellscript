...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_ModifyCmdReject data;
   TS24501Msg_ModifyCmdReject* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.msgAuthCode = 34000;
   pdu.secHdr.seqNumber  = 130;
   pdu.protoDiscr = TS24501Msg_NAS5GProtoDiscr_sessMgmt5G;
   pdu.hdrData.u.sm.pduSessIdent = TS24501Msg_PDUSessionIdentity_pduId3;
   pdu.hdrData.u.sm.procTransIdent = 230;

   asn1SetTC_TS24501Msg_PDU_obj_ModifyCmdReject5G (&ctxt, &pdu, pvalue);
