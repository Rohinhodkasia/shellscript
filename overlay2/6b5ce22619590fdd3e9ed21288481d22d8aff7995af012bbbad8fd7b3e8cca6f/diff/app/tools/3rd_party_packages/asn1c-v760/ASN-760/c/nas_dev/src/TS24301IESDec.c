   ...
   , TS24301IE_UENetworkCapability* pvalue)
{
   ...
   if ( rtxCtxtContainerHasRemBits(pctxt) )  {
      ...
      ret = rtxDecBitsToByte (pctxt, &pvalue->octet10.spare, 3);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet10.v2x_nr_pc5);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet10.up_mt_edt);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet10.cp_mt_edt);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_SMSServicesStatus* pvalue)
{
   ...
   ret = NASDec_TS24301IE_SMSStatusValues (pctxt, &pvalue->value);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_CSFBResponse* pvalue)
{
   ...
   ret = NASDec_TS24301IE_CSFBRespValues (pctxt, &pvalue->value);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_EPSAttachResult* pvalue)
{
   ...
   ret = NASDec_TS24301IE_EPSAttachResultValues (pctxt, &pvalue->result);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_EPSNetworkFeatureSupport* pvalue)
{
   ...
   if ( rtxCtxtContainerHasRemBits(pctxt) )  {
      ...
      ret = rtxDecBitsToByte (pctxt, &pvalue->octet5.spare, 4);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet5.pr);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet5.rpr);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet5.piv);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet5.ncr);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_EPSUpdateResult* pvalue)
{
   ...
   ret = NASDec_TS24301IE_EPSUpdateResultValues (pctxt, &pvalue->result);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_UERequestType* pvalue)
{
   ...
   ret = NASDec_TS24301IE_UERequestTypes (pctxt, &pvalue->type);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_PagingRestriction* pvalue)
{
   ...
   ret = NASDec_TS24301IE_RestrictionTypes (pctxt, &pvalue->type);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   if ( rtxCtxtContainerHasRemBits(pctxt) )  {
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet4.ebi7);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet4.ebi6);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet4.ebi5);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet4.ebi4);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet4.ebi3);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet4.ebi2);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet4.ebi1);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet4.ebi0);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   if ( rtxCtxtContainerHasRemBits(pctxt) )  {
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet5.ebi15);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet5.ebi14);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet5.ebi13);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet5.ebi12);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet5.ebi11);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet5.ebi10);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet5.ebi9);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      ret = rtxDecBit (pctxt, &pvalue->octet5.ebi8);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_UserIdentity* pvalue)
{
   ...
   ret = rtxDecBitsToByte (pctxt, &pvalue->userDigit1, 4);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   ret = NASDec_TS24301IE_UserIdentityType (pctxt, &pvalue->userType1);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   ret = rtxDecUInt32 (pctxt, &pvalue->userDigits.numocts, 1);
   if (ret < 0) return LOG_RTERR (pctxt, ret);

   {
      OSOCTET *tmpdata = (OSOCTET*) rtxMemAlloc (pctxt, pvalue->userDigits.numocts);
      if (0 == tmpdata) return LOG_RTERR (pctxt, RTERR_NOMEM);

      ret = rtxDecBitsToByteArray (pctxt, tmpdata, pvalue->userDigits.numocts, pvalue->userDigits.numocts * 8);
      if (ret < 0) return LOG_RTERR (pctxt, ret);

      pvalue->userDigits.data = tmpdata;
   }
   ...
   , TS24301IE_RemoteUECtxt* pvalue)
{
   ...
   {
      OSRTDList tmplist;
      TS24301IE_UserIdentity* pdata;

      tmplist.head = tmplist.tail = (OSRTDListNode*) 0;
      tmplist.count = 0;

      OSUINT8 i;
      for (i = 0; i < pvalue->numUserIdents; i++) {

         pdata = rtxMemAllocType (pctxt, TS24301IE_UserIdentity);

         if (pdata == NULL)
            return LOG_RTERR (pctxt, RTERR_NOMEM);

         asn1Init_TS24301IE_UserIdentity (pdata);

         RTXCTXTPUSHARRAYELEMNAME (pctxt, "elem", (OSUINT8)tmplist.count);

         ret = NASDec_TS24301IE_UserIdentity (pctxt, pdata);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   ret = rtxDecUInt32 (pctxt, &pvalue->addrInfo.numocts, 1);
   if (ret < 0) return LOG_RTERR (pctxt, ret);

   {
      OSOCTET *tmpdata = (OSOCTET*) rtxMemAlloc (pctxt, pvalue->addrInfo.numocts);
      if (0 == tmpdata) return LOG_RTERR (pctxt, RTERR_NOMEM);

      ret = rtxDecBitsToByteArray (pctxt, tmpdata, pvalue->addrInfo.numocts, pvalue->addrInfo.numocts * 8);
      if (ret < 0) return LOG_RTERR (pctxt, ret);

      pvalue->addrInfo.data = tmpdata;
   }
   ...
   , TS24301IE_RemoteUECtxtList* pvalue)
{
...

   {
      ...
      OSUINT8 i;
      for (i = 0; i < pvalue->numRemUECtxts; i++) {
   ...
   , TS24301IE_PKMFAddress* pvalue)
{
   ...
   ret = NASDec_TS24301IE_PKMFAddress_addrType (pctxt, &pvalue->addrType);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24301IE_HdrCompressConfig* pvalue)
{
   ...
   if ( rtxCtxtContainerHasRemBits(pctxt) )  {
      ...
      ret = NASDec_TS24301IE_HdrCompressCtxtParams (pctxt, &pvalue->
         addlSetupType);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   if ( rtxCtxtContainerHasRemBits(pctxt) )  {
      ...
      pvalue->addlSetupContainer.numocts = (OSUINT32)(rtxCtxtGetContainerRemBits(pctxt)/8);
      if ( pvalue->addlSetupContainer.numocts > 0 ) {
         RTDIAG_NEWBITFIELD (pctxt, "OCTET STRING");

         {
            OSOCTET *tmpdata = (OSOCTET*) rtxMemAlloc (pctxt, pvalue->addlSetupContainer.numocts);
            if (0 == tmpdata) return LOG_RTERR (pctxt, RTERR_NOMEM);

            ret = rtxDecBitsToByteArray (pctxt, tmpdata, pvalue->addlSetupContainer.numocts, pvalue->addlSetupContainer.numocts * 8);
            if (ret < 0) return LOG_RTERR (pctxt, ret);

            pvalue->addlSetupContainer.data = tmpdata;
         }
