...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_SecModeDone data;
   TS24501Msg_SecModeDone* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.seqNumber  = 20;
   pdu.hdrData.u.mm.secHdrType = TS24501Msg_NAS5GSecHdrType_noSec;

   asn1SetTC_TS24501Msg_PDU_obj_SecModeDone5G (&ctxt, &pdu, pvalue);

   asn1Init_TS24501Msg_SecModeDone (pvalue);

   pvalue->m.imeisvPresent = 1;
   pvalue->imeisv.t = T_TS24501IE_MobileIdentity_imeisv;
   OSCRTLSTRNCPY_S (pvalue->imeisv.u.imeisv, 17, "8788466225252427", 17);

   pvalue->m.nasMsgContainerPresent = 1;
   pvalue->nasMsgContainer.length = 0; // Calculated automatically...
   pvalue->nasMsgContainer.contents.numocts = 1;
   pvalue->nasMsgContainer.contents.data = (OSOCTET*) rtxMemAlloc (&ctxt, 1);
   {
