...
{
   TS24008Msg_PDU pdu;
   TS24008Msg_EmergencySetup data;
   TS24008Msg_EmergencySetup* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_mt_EmergencySetup;
   pdu.data.t = T_TS24008Msgs_TS24008_IE_OBJECTSET_obj_EmergencySetup;
   pdu.data.u.obj_EmergencySetup = pvalue;
   ...
   pvalue->streamId.value = 184;
   pvalue->m.supportedCodecsPresent = 1;
   pvalue->supportedCodecs.length = 36;
   pvalue->supportedCodecs.codecs.n = 1;
   pvalue->supportedCodecs.codecs.elem[0].sysID = 57;
   {
