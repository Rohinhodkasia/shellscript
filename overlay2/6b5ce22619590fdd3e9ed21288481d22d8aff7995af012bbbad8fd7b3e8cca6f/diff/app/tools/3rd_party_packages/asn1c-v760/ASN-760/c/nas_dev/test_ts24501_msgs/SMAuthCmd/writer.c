...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_SMAuthCmd data;
   TS24501Msg_SMAuthCmd* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.hdrData.u.sm.pduSessIdent = TS24501Msg_PDUSessionIdentity_pduId10;
   pdu.hdrData.u.sm.procTransIdent = 64;

   asn1SetTC_TS24501Msg_PDU_obj_SMAuthCmd5G (&ctxt, &pdu, pvalue);
   ...
   {
      static const OSOCTET tmpdata[] = { 0x3d, 0x17, 0x8a, 0x77 };
