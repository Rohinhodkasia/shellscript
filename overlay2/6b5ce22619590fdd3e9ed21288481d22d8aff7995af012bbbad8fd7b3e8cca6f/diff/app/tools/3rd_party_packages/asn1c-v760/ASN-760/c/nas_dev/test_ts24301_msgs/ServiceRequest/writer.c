...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_ServiceRequest data;
   TS24301Msg_ServiceRequest* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.secHdrType = TS24007L3_SecHdrType_secHdrForSvcReq;
   pdu.secHdr.protoDiscr = TS24007L3_ProtoDiscr_epsMobMgmt;
   pdu.secHdr.msgAuthCode = 0;
   pdu.secHdr.seqNumber  = 0;
   pdu.l3HdrOpts.t = T_TS24007L3_L3HdrOptions_skipInd;
   pdu.l3HdrOpts.u.skipInd = 0;
   asn1SetTC_TS24301Msg_PDU_obj_ServiceRequest (&ctxt, &pdu, pvalue);

   pvalue->secHdr = TS24007L3_SecHdrType_secHdrForSvcReq;
   pvalue->protoDiscr = TS24007L3_ProtoDiscr_epsMobMgmt;
   pvalue->ksiAndSequenceNumber.ksi = 5;
   pvalue->ksiAndSequenceNumber.seqNo = 15;
   {
      static const OSOCTET testdata[] = { 0x9d, 0xad };
      OSCRTLMEMCPY ((void*)pvalue->shortMAC.data, testdata, 2);
   }
