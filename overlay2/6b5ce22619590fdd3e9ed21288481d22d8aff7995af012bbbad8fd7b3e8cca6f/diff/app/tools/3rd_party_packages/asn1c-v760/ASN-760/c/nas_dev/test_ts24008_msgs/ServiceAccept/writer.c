...
{
   TS24008Msg_PDU pdu;
   TS24008Msg_ServiceAccept data;
   TS24008Msg_ServiceAccept* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_mt_ServiceAccept;
   pdu.data.t = T_TS24008Msgs_TS24008_IE_OBJECTSET_obj_ServiceAccept;
   pdu.data.u.obj_ServiceAccept = pvalue;
