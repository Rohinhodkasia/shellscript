...
{
   TS24008Msg_PDU pdu;
   TS24008Msg_CongestionControl data;
   TS24008Msg_CongestionControl* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_mt_CongestionControl;
   pdu.data.t = T_TS24008Msgs_TS24008_IE_OBJECTSET_obj_CongestionControl;
   pdu.data.u.obj_CongestionControl = pvalue;
   ...
   pvalue->cause.recommendation = 13;
