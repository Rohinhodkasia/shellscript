...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_CSServiceNotif data;
   TS24301Msg_CSServiceNotif* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pvalue->m.lcsClientIdentityPresent = 1;
   {
      ...
      OSCRTLMEMCPY ((void*)pvalue->lcsClientIdentity.data, testdata, 1);
   }
