 ...
 */
package sample_json.PKCS15TokenInfo;
...
public class Writer {
   ...
   /* PDU: PKCS15TokenInfo.Identifier */
   public static void main(String args[]) {
      ...
      try {
         ...
         Asn1JsonOutputStream encbuf1 = new Asn1JsonOutputStream (buffer);
         Asn1Null nullElement = new Asn1Null ();
         nullElement.encode (encbuf1);
         Asn1OpenType nullOpenType = new Asn1OpenType (
            buffer.toCharArray(), Asn1OpenType.JSON);

         buffer.reset();
         Asn1JsonOutputStream encbuf2 = new Asn1JsonOutputStream (buffer);
         byte[] octStrValue = { 0, 0, 0, 0, 0, 0, 0, 0 };
         Asn1OctetString octStr = new Asn1OctetString (octStrValue);
         octStr.encode (encbuf2);
         Asn1OpenType octStrOpenType = new Asn1OpenType (
            buffer.toCharArray(), Asn1OpenType.JSON);
