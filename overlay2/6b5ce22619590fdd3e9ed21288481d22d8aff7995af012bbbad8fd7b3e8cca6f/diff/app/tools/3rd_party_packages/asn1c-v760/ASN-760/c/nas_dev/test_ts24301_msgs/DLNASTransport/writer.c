...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_DLNASTransport data;
   TS24301Msg_DLNASTransport* pvalue = &data;
   OSCTXT	ctxt;
   ...
   asn1SetTC_TS24301Msg_PDU_obj_DLNASTransport (&ctxt, &pdu, pvalue);

   asn1Init_TS24301Msg_DLNASTransport (pvalue);
   {
      static const OSOCTET testdata[] = { 0x7c, 0xe5 };
      pvalue->numocts = 2;
      OSCRTLMEMCPY ((void*)pvalue->data, testdata, 2);
   }
