...
int main (int argc, char** argv)
{
   ...
   pvalue = rtxMemAllocType (&ctxt, TS24301IE_NASSecurityAlgorithms);
   ...
   ret = NASEnc_TS24301IE_NASSecurityAlgorithms (&ctxt, pvalue);
   if (0 != ret) {
      printf ("encode NASSecurityAlgorithms failed; status = %d\n", ret);
      rtxErrPrint (&ctxt);
      return ret;
   }
