...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_NetSliceAuthDone data;
   TS24501Msg_NetSliceAuthDone* pvalue = &data;
   OSCTXT	ctxt;
   ...
   {
      static const OSOCTET tmpdata[] = { 0x77, 0x5a };
