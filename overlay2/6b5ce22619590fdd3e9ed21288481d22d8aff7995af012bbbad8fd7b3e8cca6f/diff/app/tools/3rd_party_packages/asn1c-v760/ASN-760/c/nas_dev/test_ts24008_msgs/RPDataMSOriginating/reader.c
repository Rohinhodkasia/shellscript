...
int main (int argc, char** argv)
{
   ...
   ret = NASDec_TS24011Msg_RPHeader (&ctxt, &header);
   if (0 != ret) {
   ...
   ret = NASDec_TS24011Msg_RPDataMSOriginating (&ctxt, &data);
   if (0 != ret) {
   ...
   if (verbose) {
      ...
      asn1PrtToStrm_TS24011Msg_RPHeader (&ctxt, "RPHeader", &header);
      asn1PrtToStrm_TS24011Msg_RPDataMSOriginating
         (&ctxt, "RPDataMSOriginating", &data);
   }
