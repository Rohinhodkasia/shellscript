...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_AuthReject data;
   TS24501Msg_AuthReject* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.msgAuthCode = 2000;
   pdu.secHdr.seqNumber = 2;
   pdu.hdrData.u.mm.secHdrType = TS24501Msg_NAS5GSecHdrType_integProt;

   asn1SetTC_TS24501Msg_PDU_obj_MMAuthReject5G (&ctxt, &pdu, pvalue);
   ...
   pvalue->eapMessage.packetFormat.id = 250;
   pvalue->eapMessage.packetFormat.length = 6;
   pvalue->eapMessage.packetFormat.data.numocts = 2;
   pvalue->eapMessage.packetFormat.data.data = (OSOCTET*) rtxMemAlloc(&ctxt, 2);
   {
      static const OSOCTET tmpdata[] = { 0x01, 0x23 };
      OSCRTLSAFEMEMCPY((void*)pvalue->eapMessage.packetFormat.data.data, 2, tmpdata, 2);
   }
