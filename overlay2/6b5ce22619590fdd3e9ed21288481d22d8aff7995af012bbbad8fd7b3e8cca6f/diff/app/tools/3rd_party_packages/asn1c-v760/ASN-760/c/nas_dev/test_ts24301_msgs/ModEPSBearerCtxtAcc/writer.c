...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_ModEPSBearerCtxtAcc data;
   TS24301Msg_ModEPSBearerCtxtAcc* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_ts24301Msg_mt_ModEPSBearerCtxtAcc;
   pdu.data.t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_ModEPSBearerCtxtAcc;
   pdu.data.u.obj_ModEPSBearerCtxtAcc = pvalue;

   asn1Init_TS24301Msg_ModEPSBearerCtxtAcc (pvalue);
   pvalue->m.protocolConfigOptionsPresent = 1;
   pvalue->protocolConfigOptions.length = 161;
