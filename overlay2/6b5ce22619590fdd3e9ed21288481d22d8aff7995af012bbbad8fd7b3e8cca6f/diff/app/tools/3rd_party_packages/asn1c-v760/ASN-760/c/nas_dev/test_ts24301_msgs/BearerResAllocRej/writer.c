...
int main (int argc, char** argv)
{
   ...
   TS24301Msg_BearerResAllocRej data;
   TS24301Msg_BearerResAllocRej* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_ts24301Msg_mt_BearerResAllocRej;
   pdu.data.t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_BearerResAllocRej;
   pdu.data.u.obj_BearerResAllocRej = pvalue;
   ...
   pvalue->protocolConfigOptions.length = 138;
