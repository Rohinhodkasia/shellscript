...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_DeactEPSBearerCtxtReq data;
   TS24301Msg_DeactEPSBearerCtxtReq* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_ts24301Msg_mt_DeactEPSBearerCtxtReq;
   pdu.data.t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_DeactEPSBearerCtxtReq;
   pdu.data.u.obj_DeactEPSBearerCtxtReq = pvalue;
   ...
   pvalue->protocolConfigOptions.length = 1;
