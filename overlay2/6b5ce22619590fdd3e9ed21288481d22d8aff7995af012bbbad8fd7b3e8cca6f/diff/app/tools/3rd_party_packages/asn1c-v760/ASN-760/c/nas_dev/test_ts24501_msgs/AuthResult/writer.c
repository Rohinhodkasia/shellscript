...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_AuthResult data;
   TS24501Msg_AuthResult* pvalue = &data;
   OSCTXT	ctxt;
   ...
   asn1SetTC_TS24501Msg_PDU_obj_MMAuthResult5G (&ctxt, &pdu, pvalue);
   ...
   pvalue->eapMessage.packetFormat.id = 35;
   ...
   {
      static const OSOCTET tmpdata[] = { 0x75, 0xde, 0x98, 0x59 };
