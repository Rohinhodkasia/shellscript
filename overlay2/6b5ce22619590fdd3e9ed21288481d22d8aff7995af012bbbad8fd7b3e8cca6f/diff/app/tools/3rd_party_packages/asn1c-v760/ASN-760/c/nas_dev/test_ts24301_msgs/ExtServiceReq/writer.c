...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_ExtServiceReq data;
   TS24301Msg_ExtServiceReq* pvalue = &data;
   OSCTXT	ctxt;
   ...
   asn1SetTC_TS24301Msg_PDU_obj_ExtServiceReq (&ctxt, &pdu, pvalue);

   asn1Init_TS24301Msg_ExtServiceReq (pvalue);

   pvalue->nasKeySetIdentifier.tsc = 1;
   pvalue->nasKeySetIdentifier.ident = 4;
   pvalue->serviceType = 12;

   pvalue->m_tmsi.t =  1;
   rtxStrncpy(pvalue->m_tmsi.u.imsi, sizeof(pvalue->m_tmsi.u.imsi),
              "270b3#3*ba4*32", 15);

   pvalue->m.csfbResponsePresent = 1;
   pvalue->csfbResponse.spare = 0;
   pvalue->csfbResponse.value = TS24301IE_CSFBRespValues_accepted;
