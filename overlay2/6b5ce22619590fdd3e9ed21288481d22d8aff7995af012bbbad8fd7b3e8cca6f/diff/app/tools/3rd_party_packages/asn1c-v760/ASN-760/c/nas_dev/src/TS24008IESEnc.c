   ...
   , TS24008IE_MobileStationClassmark1* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_RFPowerCapValues (pctxt, pvalue->rfPowerCap);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_CallingPartyBCDNumber_octet3* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_NumberTypes (pctxt, pvalue->typeOfNumber);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   ret = NASEnc_TS24008IE_NumberPlans (pctxt, pvalue->numberingPlanID);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_PartySubaddress_octet3* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_SubAddressTypes (pctxt, pvalue->typeOfSubaddr);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_RadioPriority2* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_RadioPriority (pctxt, pvalue);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_NotificationIndicator* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_NotifIndValues (pctxt, pvalue->value);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_ProgressIndicator_octet3* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_PILocation (pctxt, pvalue->location);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_AlertingPattern* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_AlertingValues (pctxt, pvalue->value);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_AddnUpdateType* pvalue)
{
   ...
   if (!(pvalue->pnb <= 3)) {
      rtxErrAddElemNameParm (pctxt);
      rtxErrAddIntParm (pctxt, (int)pvalue->pnb);
      return LOG_RTERR (pctxt, RTERR_CONSVIO);
   }

   RTDIAG_NEWBITFIELD (pctxt, "INTEGER");

   ret = rtxEncBits (pctxt, pvalue->pnb, 2);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_AttachResult* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_AttachResultValues (pctxt, pvalue->resultOfAttach);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_IntegrityAlgorithmType* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_IntegrityTypes (pctxt, pvalue->value);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_UpdateResult* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_UpdateResultValues (pctxt, pvalue->value);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_UpdateType* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_UpdateTypeValues (pctxt, pvalue->value);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_ServiceType* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_ServiceTypeValues (pctxt, pvalue->value);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_ExtDRXParams* pvalue)
{
   ...
   ret = rtxEncBits (pctxt, pvalue->pagingTimeWindow, 4);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   ret = rtxEncBits (pctxt, pvalue->eDRXValue, 4);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_NSAPIValue* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_NSAPIValues (pctxt, pvalue->value);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_LLCSAPIValue* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_SAPIValues (pctxt, pvalue->value);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_IPv4Address* pvalue)
{
   ...
   ret = rtxEncBitsFromByteArray (pctxt, pvalue->addr, 32);
   ...
   ret = rtxEncBitsFromByteArray (pctxt, pvalue->mask, 32);
   ...
   , TS24008IE_IPv6Address* pvalue)
{
   ...
   ret = rtxEncBitsFromByteArray (pctxt, pvalue->addr, 128);
   ...
   ret = rtxEncBitsFromByteArray (pctxt, pvalue->mask, 128);
   ...
   , TS24008IE_IPv6AddressPrefix* pvalue)
{
   ...
   ret = rtxEncBitsFromByteArray (pctxt, pvalue->prefix, 8);
   ...
   , TS24008IE_PortRange* pvalue)
{
   ...
   ret = rtxEncUInt32 (pctxt, pvalue->low, 2);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   ret = rtxEncUInt32 (pctxt, pvalue->high, 2);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_TFTPacketFilterComponent* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_TFTPacketFilterComponentType (pctxt, pvalue->id);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   switch (pvalue->id)
   {
      ...
      case 16:
         ...
         ret = NASEnc_TS24008IE_IPv4Address (pctxt, &pvalue->value.u.ipv4Remote
            );
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 17:
         ...
         ret = NASEnc_TS24008IE_IPv4Address (pctxt, &pvalue->value.u.ipv4Local
            );
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 32:
         ...
         ret = NASEnc_TS24008IE_IPv6Address (pctxt, &pvalue->value.u.ipv6Remote
            );
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 33:
         ...
         ret = NASEnc_TS24008IE_IPv6AddressPrefix (pctxt, &pvalue->value.
      ...
      case 48:
         ...
         ret = rtxEncUInt32 (pctxt, pvalue->value.u.protoIdNextHdr, 1);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 64:
         ...
         ret = rtxEncUInt32 (pctxt, pvalue->value.u.singleLocalPort, 2);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 65:
         ...
         ret = NASEnc_TS24008IE_PortRange (pctxt, &pvalue->value.
            u.localPortRange);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 80:
         ...
         ret = rtxEncUInt32 (pctxt, pvalue->value.u.singleRemotePort, 2);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 96:
         ...
         ret = rtxEncUInt32 (pctxt, pvalue->value.u.secParamIndex, 4);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 112:
         ...
         ret = rtxEncUInt32 (pctxt, pvalue->value.u.typeOfSvcTrafficClass.class_, 1);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         ret = rtxEncUInt32 (pctxt, pvalue->value.u.typeOfSvcTrafficClass.mask, 1);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 128:
         ...
         RTXCTXTPUSHELEMNAME (pctxt, "spare");
         if (!(pvalue->value.u.flowLabel.spare <= 15)) {
            rtxErrAddElemNameParm (pctxt);
            rtxErrAddIntParm (pctxt, (int)pvalue->value.u.flowLabel.spare);
            return LOG_RTERR (pctxt, RTERR_CONSVIO);
         }

         RTDIAG_NEWBITFIELD (pctxt, "INTEGER");

         ret = rtxEncBits (pctxt, pvalue->value.u.flowLabel.spare, 4);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         if (!(pvalue->value.u.flowLabel.label <= 1048575)) {
            rtxErrAddElemNameParm (pctxt);
            rtxErrAddUIntParm (pctxt, pvalue->value.u.flowLabel.label);
            return LOG_RTERR (pctxt, RTERR_CONSVIO);
         }

         RTDIAG_NEWBITFIELD (pctxt, "INTEGER");

         ret = rtxEncBits (pctxt, pvalue->value.u.flowLabel.label, 20);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_TFTPacketFilterContent* pvalue)
{
   ...
   {
      OSUINT8 i;
      for (i = 0; i < pvalue->components.n; i++) {
         RTXCTXTPUSHARRAYELEMNAME (pctxt, "elem", i);

         ret = NASEnc_TS24008IE_TFTPacketFilterComponent (pctxt, &pvalue->
            components.elem[i]);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24008IE_TFTPacketFilterItem* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_TFTPacketFilterContent (pctxt, &pvalue->contents);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   )
{
   ...
   ret = NASEnc_TS24008IE_TFTParamId (pctxt, pvalue->paramIdentifier);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   switch (pvalue->paramIdentifier)
   {
      ...
      case 1:
         ...
         ret = rtxEncUInt32 (pctxt, pvalue->contents.u.authToken.numocts, 1);
         if (ret < 0) return LOG_RTERR (pctxt, ret);

         ret = rtxEncBitsFromByteArray (pctxt, pvalue->contents.u.authToken.data, pvalue->contents.u.authToken.numocts * 8);
      ...
      case 2:
         ...
         /* encode mediaComponentNum */

         RTXCTXTPUSHELEMNAME (pctxt, "mediaComponentNum");
         RTDIAG_NEWBITFIELD (pctxt, "INTEGER");

         ret = rtxEncUInt32 (pctxt, pvalue->contents.u.flowId.mediaComponentNum, 2);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
         ...
         ret = rtxEncUInt32 (pctxt, pvalue->contents.u.flowId.ipFlowNum, 2);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
      ...
      case 3:
         ...
         ret = rtxEncUInt32 (pctxt, pvalue->contents.u.packetFilterIdList.numocts, 1);
         if (ret < 0) return LOG_RTERR (pctxt, ret);

         ret = rtxEncBitsFromByteArray (pctxt, pvalue->contents.u.packetFilterIdList.data, pvalue->contents.u.packetFilterIdList.numocts * 8);
      ...
      default:
         ...
         ret = rtxEncUInt32 (pctxt, pvalue->contents.u.unknown.numocts, 1);
         if (ret < 0) return LOG_RTERR (pctxt, ret);

         ret = rtxEncBitsFromByteArray (pctxt, pvalue->contents.u.unknown.data, pvalue->contents.u.unknown.numocts * 8);
   ...
   , TS24008IE_RequestTypeValue* pvalue)
{
   ...
   ret = NASEnc_TS24008IE_ReqTypeValues (pctxt, pvalue->value);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
