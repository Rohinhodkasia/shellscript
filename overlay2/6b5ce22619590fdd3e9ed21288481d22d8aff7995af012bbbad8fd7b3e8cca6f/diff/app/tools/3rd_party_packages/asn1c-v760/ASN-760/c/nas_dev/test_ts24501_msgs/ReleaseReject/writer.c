...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_ReleaseReject data;
   TS24501Msg_ReleaseReject* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.hdrData.u.sm.pduSessIdent = TS24501Msg_PDUSessionIdentity_pduId12;
   pdu.hdrData.u.sm.procTransIdent = 220;

   asn1SetTC_TS24501Msg_PDU_obj_ReleaseReject5G (&ctxt, &pdu, pvalue);
