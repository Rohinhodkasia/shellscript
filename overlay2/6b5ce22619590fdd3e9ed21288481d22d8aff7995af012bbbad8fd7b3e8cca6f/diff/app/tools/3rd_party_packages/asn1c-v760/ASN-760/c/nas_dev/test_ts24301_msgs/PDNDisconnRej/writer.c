...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_PDNDisconnRej data;
   TS24301Msg_PDNDisconnRej * pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_ts24301Msg_mt_PDNDisconnRej;
   pdu.data.t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_PDNDisconnRej;
   pdu.data.u.obj_PDNDisconnRej = pvalue;
   ...
   pvalue->protocolConfigOptions.length = 146;
