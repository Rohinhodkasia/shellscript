...
{
   TS24008Msg_PDU pdu;
   TS24008IE_Cause data;
   TS24008IE_Cause* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_mt_HoldReject;
   pdu.data.t = T_TS24008Msgs_TS24008_IE_OBJECTSET_obj_HoldReject;
   pdu.data.u.obj_HoldReject = pvalue;
   ...
   pvalue->recommendation = 48;
   pvalue->causeValue = 71;
