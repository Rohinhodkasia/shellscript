...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_ESMInfoResp data;
   TS24301Msg_ESMInfoResp* pvalue = &data;
   OSCTXT	ctxt;
   OSCTXT	*pctxt = &ctxt;
   ...
   pdu.msgType = ASN1V_ts24301Msg_mt_ESMInfoResp;
   pdu.data.t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_ESMInfoResp;
   pdu.data.u.obj_ESMInfoResp = pvalue;
   ...
   pvalue->protocolConfigOptions.length = 229;
