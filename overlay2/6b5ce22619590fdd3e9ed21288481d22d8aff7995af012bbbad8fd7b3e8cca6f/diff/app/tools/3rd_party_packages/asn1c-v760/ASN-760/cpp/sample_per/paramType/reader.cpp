 ...
 * (http://www.obj-sys.com).  Version: 7.1.A, Date: 29-Oct-2016.
 */
#include "ParamType.h"
...
int main (int argc, char** argv)
{
   ...
   ASN1T_SignedName data;
   ASN1C_SignedName SignedNamePDU (decodeBuffer, data);
   ...
   if (trace) {
      ...
      SignedNamePDU.Print ("SignedName");
   }
   return 0;
}
