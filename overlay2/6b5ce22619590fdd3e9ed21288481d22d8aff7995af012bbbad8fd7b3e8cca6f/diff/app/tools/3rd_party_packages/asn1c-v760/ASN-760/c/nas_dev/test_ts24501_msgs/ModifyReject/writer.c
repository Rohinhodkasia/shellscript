...
{
   TS24501Msg_PDU pdu;
   TS24501Msg_ModifyReject data;
   TS24501Msg_ModifyReject* pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.secHdr.msgAuthCode = 33000;
   pdu.secHdr.seqNumber  = 140;
   pdu.protoDiscr = TS24501Msg_NAS5GProtoDiscr_sessMgmt5G;
   pdu.hdrData.u.sm.pduSessIdent = TS24501Msg_PDUSessionIdentity_pduId5;
   pdu.hdrData.u.sm.procTransIdent = 240;

   asn1SetTC_TS24501Msg_PDU_obj_ModifyReject5G (&ctxt, &pdu, pvalue);
   ...
   pvalue->backoffTimer.timerValue = 10;
