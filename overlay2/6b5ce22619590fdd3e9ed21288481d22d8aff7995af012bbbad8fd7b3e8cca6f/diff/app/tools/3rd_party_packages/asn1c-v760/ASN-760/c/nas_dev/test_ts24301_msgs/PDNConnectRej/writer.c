...
{
   TS24301Msg_PDU pdu;
   TS24301Msg_PDNConnectRej data;
   TS24301Msg_PDNConnectRej * pvalue = &data;
   OSCTXT	ctxt;
   ...
   pdu.msgType = ASN1V_ts24301Msg_mt_PDNConnectRej;
   pdu.data.t = T_TS24301Msgs_TS24301_IE_OBJECTSET_obj_PDNConnectRej;
   pdu.data.u.obj_PDNConnectRej = pvalue;
   ...
   pvalue->protocolConfigOptions.length = 99;
