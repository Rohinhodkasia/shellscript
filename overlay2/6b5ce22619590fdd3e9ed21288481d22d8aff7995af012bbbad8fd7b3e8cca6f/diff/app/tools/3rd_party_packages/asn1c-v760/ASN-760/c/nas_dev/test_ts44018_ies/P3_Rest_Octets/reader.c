...
int main (int argc, char** argv)
{
   ...
   ret = NASDec_TS44018IE_P3_Rest_Octets (&ctxt, &data);

   if (verbose) {
      printf ("Bit fields:\n");
      rtxDiagBitTracePrint (ctxt.pBitFldList, "P3_Rest_Octets");
      printf ("\n");
   }

   if (0 != ret) {
      printf ("decode P3_Rest_Octets failed; status = %d\n", ret);
      rtxErrPrint (&ctxt);
      return ret;
   }
   ...
   if (verbose) {
      ...
      asn1PrtToStrm_TS44018IE_P3_Rest_Octets
         (&ctxt, "P3_Rest_Octets", &data);
   }
