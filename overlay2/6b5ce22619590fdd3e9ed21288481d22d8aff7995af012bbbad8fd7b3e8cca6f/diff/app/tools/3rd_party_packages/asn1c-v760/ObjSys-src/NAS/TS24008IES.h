...
TMGI ::= SEQUENCE {
   ...
   --<noPresentBit/>
   mcc-mnc [1] MCCMNCPair OPTIONAL
}
*/
typedef struct EXTERN TS24008IE_TMGI {
   struct {
      unsigned mcc_mncPresent : 1;
   } m;
   OSOCTET mbmsServiceID[3];
   TS24008IE_MCCMNCPair mcc_mnc;
} TS24008IE_TMGI;
...
/**************************************************************/
/*
RFPowerCapValues ::= ENUMERATED { class1(0), class2(1), class3(2), class4(3), class5(4), rfMAX(7) }
*/
typedef enum {
   TS24008IE_RFPowerCapValues_class1 = 0,
   TS24008IE_RFPowerCapValues_class2 = 1,
   TS24008IE_RFPowerCapValues_class3 = 2,
   TS24008IE_RFPowerCapValues_class4 = 3,
   TS24008IE_RFPowerCapValues_class5 = 4,
   TS24008IE_RFPowerCapValues_rfMAX = 7
} TS24008IE_RFPowerCapValues;

EXTERN int NASEnc_TS24008IE_RFPowerCapValues (OSCTXT* pctxt
   , TS24008IE_RFPowerCapValues value);

EXTERN int NASDec_TS24008IE_RFPowerCapValues (OSCTXT* pctxt
   , TS24008IE_RFPowerCapValues* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_RFPowerCapValues (OSCTXT *pctxt, 
   const char* name, const TS24008IE_RFPowerCapValues* pvalue);

EXTERN extern const OSEnumItem TS24008IE_RFPowerCapValues_ENUMTAB[];
#define TS24008IE_RFPowerCapValues_ENUMTABSIZE 6

EXTERN const OSUTF8CHAR* TS24008IE_RFPowerCapValues_ToString (OSINT32 value);

EXTERN int TS24008IE_RFPowerCapValues_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_RFPowerCapValues* pvalue);

EXTERN int TS24008IE_RFPowerCapValues_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, 
      TS24008IE_RFPowerCapValues* pvalue);

EXTERN TS24008IE_RFPowerCapValues*
    asn1Test_TS24008IE_RFPowerCapValues (OSCTXT* pctxt);
...
typedef struct EXTERN TS24008IE_MobileStationClassmark1 {
   ...
   OSBOOL esInd;
   OSBOOL a5_1_alg;
   TS24008IE_RFPowerCapValues rfPowerCap;
...
MultibandSupported ::= SEQUENCE {
   supported [0] MBSEnum,
   a5bits [1] A5Bits,
   assocRadioCap2 [2] INTEGER (0..15) OPTIONAL,
   assocRadioCap1 [3] INTEGER (0..15) OPTIONAL
}
*/
typedef struct EXTERN TS24008IE_MultibandSupported {
   struct {
      unsigned assocRadioCap2Present : 1;
      unsigned assocRadioCap1Present : 1;
   } m;
...
EXTERN int asn1Init_TS24008IE_MultibandSupported (
   TS24008IE_MultibandSupported* pvalue);
...
CMServiceType ::= ENUMERATED { mobOrigCallEstab(1), emerCallEstab(2), sms(4), suplSvcActv(8), voiceGrpCallEstab(9), voiceBcastCallEstab(10), locationSvcs(11), cmServiceTypeMAX(15) }
*/
typedef enum {
   ...
   TS24008IE_CMServiceType_cmServiceTypeMAX = 15
...
#define TS24008IE_CMServiceType_ENUMTABSIZE 8
...
/**************************************************************/
/*
NumberTypes ::= ENUMERATED { unk(0), international(1), national(2), network(3), shortCode(4), ntMAX(7) }
*/
typedef enum {
   TS24008IE_NumberTypes_unk = 0,
   TS24008IE_NumberTypes_international = 1,
   TS24008IE_NumberTypes_national = 2,
   TS24008IE_NumberTypes_network = 3,
   TS24008IE_NumberTypes_shortCode = 4,
   TS24008IE_NumberTypes_ntMAX = 7
} TS24008IE_NumberTypes;

EXTERN int NASEnc_TS24008IE_NumberTypes (OSCTXT* pctxt
   , TS24008IE_NumberTypes value);

EXTERN int NASDec_TS24008IE_NumberTypes (OSCTXT* pctxt
   , TS24008IE_NumberTypes* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_NumberTypes (OSCTXT *pctxt, 
   const char* name, const TS24008IE_NumberTypes* pvalue);

EXTERN extern const OSEnumItem TS24008IE_NumberTypes_ENUMTAB[];
#define TS24008IE_NumberTypes_ENUMTABSIZE 6

EXTERN const OSUTF8CHAR* TS24008IE_NumberTypes_ToString (OSINT32 value);

EXTERN int TS24008IE_NumberTypes_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_NumberTypes* pvalue);

EXTERN int TS24008IE_NumberTypes_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, TS24008IE_NumberTypes* pvalue);

EXTERN TS24008IE_NumberTypes* asn1Test_TS24008IE_NumberTypes (OSCTXT* pctxt);
...
/**************************************************************/
/*
NumberPlans ::= ENUMERATED { unk(0), isdn(1), data(3), telex(4), national(8), private(9), reservedCTS(11), reservedExt(15) }
*/
typedef enum {
   TS24008IE_NumberPlans_unk = 0,
   TS24008IE_NumberPlans_isdn = 1,
   TS24008IE_NumberPlans_data = 3,
   TS24008IE_NumberPlans_telex = 4,
   TS24008IE_NumberPlans_national = 8,
   TS24008IE_NumberPlans_private = 9,
   TS24008IE_NumberPlans_reservedCTS = 11,
   TS24008IE_NumberPlans_reservedExt = 15
} TS24008IE_NumberPlans;

EXTERN int NASEnc_TS24008IE_NumberPlans (OSCTXT* pctxt
   , TS24008IE_NumberPlans value);

EXTERN int NASDec_TS24008IE_NumberPlans (OSCTXT* pctxt
   , TS24008IE_NumberPlans* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_NumberPlans (OSCTXT *pctxt, 
   const char* name, const TS24008IE_NumberPlans* pvalue);

EXTERN extern const OSEnumItem TS24008IE_NumberPlans_ENUMTAB[];
#define TS24008IE_NumberPlans_ENUMTABSIZE 8

EXTERN const OSUTF8CHAR* TS24008IE_NumberPlans_ToString (OSINT32 value);

EXTERN int TS24008IE_NumberPlans_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_NumberPlans* pvalue);

EXTERN int TS24008IE_NumberPlans_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, TS24008IE_NumberPlans* pvalue);

EXTERN TS24008IE_NumberPlans* asn1Test_TS24008IE_NumberPlans (OSCTXT* pctxt);
...
/**************************************************************/
/*
SubAddressTypes ::= ENUMERATED { nsap(0), userSpecified(2), subAddrMAX(7) }
*/
typedef enum {
   TS24008IE_SubAddressTypes_nsap = 0,
   TS24008IE_SubAddressTypes_userSpecified = 2,
   TS24008IE_SubAddressTypes_subAddrMAX = 7
} TS24008IE_SubAddressTypes;

EXTERN int NASEnc_TS24008IE_SubAddressTypes (OSCTXT* pctxt
   , TS24008IE_SubAddressTypes value);

EXTERN int NASDec_TS24008IE_SubAddressTypes (OSCTXT* pctxt
   , TS24008IE_SubAddressTypes* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_SubAddressTypes (OSCTXT *pctxt, 
   const char* name, const TS24008IE_SubAddressTypes* pvalue);

EXTERN extern const OSEnumItem TS24008IE_SubAddressTypes_ENUMTAB[];
#define TS24008IE_SubAddressTypes_ENUMTABSIZE 3

EXTERN const OSUTF8CHAR* TS24008IE_SubAddressTypes_ToString (OSINT32 value);

EXTERN int TS24008IE_SubAddressTypes_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_SubAddressTypes* pvalue);

EXTERN int TS24008IE_SubAddressTypes_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, TS24008IE_SubAddressTypes* pvalue)
      ;

EXTERN TS24008IE_SubAddressTypes*
    asn1Test_TS24008IE_SubAddressTypes (OSCTXT* pctxt);
...
/*
 ...
 Same IE as 10.5.4.8 
 10.5.4.11 - Cause 
Location ::= ENUMERATED { user(0), prvNWServLclUser(1), pubNWServLclUser(2), transit(3), pubNWServRemUser(4), prvNWServRemUser(5), intlNetwork(7), netBeyondIntworkPt(10), locationMAX(15) }
*/
typedef enum {
   ...
   TS24008IE_Location_locationMAX = 15
} TS24008IE_Location;
...
#define TS24008IE_Location_ENUMTABSIZE 9
...
CongestionLevel ::= ENUMERATED { rcvrReady(0), rcvrNotReady(15) }
*/
typedef enum {
   TS24008IE_CongestionLevel_rcvrReady = 0,
   TS24008IE_CongestionLevel_rcvrNotReady = 15
...
EXTERN extern const OSEnumItem TS24008IE_CongestionLevel_ENUMTAB[];
#define TS24008IE_CongestionLevel_ENUMTABSIZE 2

EXTERN const OSUTF8CHAR* TS24008IE_CongestionLevel_ToString (OSINT32 value);

EXTERN int TS24008IE_CongestionLevel_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_CongestionLevel* pvalue);

EXTERN int TS24008IE_CongestionLevel_ToEnum2 (OSCTXT* pctxt,
...
typedef struct EXTERN TS24008IE_CallingPartyBCDNumber_octet3 {
   TS24008IE_NumberTypes typeOfNumber;
   TS24008IE_NumberPlans numberingPlanID;
...
CallingPartyBCDNumber ::= SEQUENCE {
   ...
   --<first3GExtElem/>
   octet3 [1] SEQUENCE {
      typeOfNumber [0] NumberTypes,
      numberingPlanID [1] NumberPlans
   },
   --<last3GExtElem/>
   octet3a [2] SEQUENCE {
...
typedef struct EXTERN TS24008IE_PartySubaddress_octet3 {
   TS24008IE_SubAddressTypes typeOfSubaddr;
...
/**************************************************************/
/*
NotifIndValues ::= ENUMERATED { userSuspended(0), userResumed(1), bearerChg(2), notifIndMAX(127) }
*/
typedef enum {
   TS24008IE_NotifIndValues_userSuspended = 0,
   TS24008IE_NotifIndValues_userResumed = 1,
   TS24008IE_NotifIndValues_bearerChg = 2,
   TS24008IE_NotifIndValues_notifIndMAX = 127
} TS24008IE_NotifIndValues;

EXTERN int NASEnc_TS24008IE_NotifIndValues (OSCTXT* pctxt
   , TS24008IE_NotifIndValues value);

EXTERN int NASDec_TS24008IE_NotifIndValues (OSCTXT* pctxt
   , TS24008IE_NotifIndValues* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_NotifIndValues (OSCTXT *pctxt, 
   const char* name, const TS24008IE_NotifIndValues* pvalue);

EXTERN extern const OSEnumItem TS24008IE_NotifIndValues_ENUMTAB[];
#define TS24008IE_NotifIndValues_ENUMTABSIZE 4

EXTERN const OSUTF8CHAR* TS24008IE_NotifIndValues_ToString (OSINT32 value);

EXTERN int TS24008IE_NotifIndValues_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_NotifIndValues* pvalue);

EXTERN int TS24008IE_NotifIndValues_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, TS24008IE_NotifIndValues* pvalue)
      ;

EXTERN TS24008IE_NotifIndValues*
    asn1Test_TS24008IE_NotifIndValues (OSCTXT* pctxt);
...
/**************************************************************/
/*
PILocation ::= ENUMERATED { user(0), privLocal(1), pubLocal(2), pubRemote(4), privRemote(5), beyond(10), locMAX(15) }
*/
typedef enum {
   TS24008IE_PILocation_user = 0,
   TS24008IE_PILocation_privLocal = 1,
   TS24008IE_PILocation_pubLocal = 2,
   TS24008IE_PILocation_pubRemote = 4,
   TS24008IE_PILocation_privRemote = 5,
   TS24008IE_PILocation_beyond = 10,
   TS24008IE_PILocation_locMAX = 15
} TS24008IE_PILocation;

EXTERN int NASEnc_TS24008IE_PILocation (OSCTXT* pctxt
   , TS24008IE_PILocation value);

EXTERN int NASDec_TS24008IE_PILocation (OSCTXT* pctxt
   , TS24008IE_PILocation* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_PILocation (OSCTXT *pctxt, 
   const char* name, const TS24008IE_PILocation* pvalue);

EXTERN extern const OSEnumItem TS24008IE_PILocation_ENUMTAB[];
#define TS24008IE_PILocation_ENUMTABSIZE 7

EXTERN const OSUTF8CHAR* TS24008IE_PILocation_ToString (OSINT32 value);

EXTERN int TS24008IE_PILocation_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_PILocation* pvalue);

EXTERN int TS24008IE_PILocation_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, TS24008IE_PILocation* pvalue);

EXTERN TS24008IE_PILocation* asn1Test_TS24008IE_PILocation (OSCTXT* pctxt);
...
RepeatIndicator ::= ENUMERATED { circular(1), fallbackSupp(2), svcChgFallback(4), repeatIndMAX(15) }
*/
typedef enum {
   TS24008IE_RepeatIndicator_circular = 1,
   TS24008IE_RepeatIndicator_fallbackSupp = 2,
   TS24008IE_RepeatIndicator_svcChgFallback = 4,
   TS24008IE_RepeatIndicator_repeatIndMAX = 15
...
EXTERN extern const OSEnumItem TS24008IE_RepeatIndicator_ENUMTAB[];
#define TS24008IE_RepeatIndicator_ENUMTABSIZE 4

EXTERN const OSUTF8CHAR* TS24008IE_RepeatIndicator_ToString (OSINT32 value);

EXTERN int TS24008IE_RepeatIndicator_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_RepeatIndicator* pvalue);

EXTERN int TS24008IE_RepeatIndicator_ToEnum2 (OSCTXT* pctxt,
...
/*
 10.5.4.23 - Signal 
Signal ::= ENUMERATED { dialOn(0), ringbackOn(1), interceptOn(2), netCongestionOn(3), busyOn(4), confirmOn(5), answerOn(6), callwaitOn(7), offhookWarnOn(8), tonesOff(63), alertOff(79), signalMAX(255) }
*/
typedef enum {
   TS24008IE_Signal_dialOn = 0,
   TS24008IE_Signal_ringbackOn = 1,
   TS24008IE_Signal_interceptOn = 2,
   TS24008IE_Signal_netCongestionOn = 3,
   TS24008IE_Signal_busyOn = 4,
   TS24008IE_Signal_confirmOn = 5,
   TS24008IE_Signal_answerOn = 6,
   TS24008IE_Signal_callwaitOn = 7,
   TS24008IE_Signal_offhookWarnOn = 8,
   TS24008IE_Signal_tonesOff = 63,
   TS24008IE_Signal_alertOff = 79,
   TS24008IE_Signal_signalMAX = 255
} TS24008IE_Signal;
...
EXTERN extern const OSEnumItem TS24008IE_Signal_ENUMTAB[];
#define TS24008IE_Signal_ENUMTABSIZE 12

EXTERN const OSUTF8CHAR* TS24008IE_Signal_ToString (OSINT32 value);

EXTERN int TS24008IE_Signal_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_Signal* pvalue);

EXTERN int TS24008IE_Signal_ToEnum2 (OSCTXT* pctxt,
...
/**************************************************************/
/*
AlertingValues ::= ENUMERATED { pattern1(0), pattern2(1), pattern3(2), pattern5(4), pattern6(5), pattern7(6), pattern8(7), pattern9(8), alertValMAX(15) }
*/
typedef enum {
   TS24008IE_AlertingValues_pattern1 = 0,
   TS24008IE_AlertingValues_pattern2 = 1,
   TS24008IE_AlertingValues_pattern3 = 2,
   TS24008IE_AlertingValues_pattern5 = 4,
   TS24008IE_AlertingValues_pattern6 = 5,
   TS24008IE_AlertingValues_pattern7 = 6,
   TS24008IE_AlertingValues_pattern8 = 7,
   TS24008IE_AlertingValues_pattern9 = 8,
   TS24008IE_AlertingValues_alertValMAX = 15
} TS24008IE_AlertingValues;

EXTERN int NASEnc_TS24008IE_AlertingValues (OSCTXT* pctxt
   , TS24008IE_AlertingValues value);

EXTERN int NASDec_TS24008IE_AlertingValues (OSCTXT* pctxt
   , TS24008IE_AlertingValues* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_AlertingValues (OSCTXT *pctxt, 
   const char* name, const TS24008IE_AlertingValues* pvalue);

EXTERN extern const OSEnumItem TS24008IE_AlertingValues_ENUMTAB[];
#define TS24008IE_AlertingValues_ENUMTABSIZE 9

EXTERN const OSUTF8CHAR* TS24008IE_AlertingValues_ToString (OSINT32 value);

EXTERN int TS24008IE_AlertingValues_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_AlertingValues* pvalue);

EXTERN int TS24008IE_AlertingValues_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, TS24008IE_AlertingValues* pvalue)
      ;

EXTERN TS24008IE_AlertingValues*
    asn1Test_TS24008IE_AlertingValues (OSCTXT* pctxt);
...
/**************************************************************/
/*
AttachResultValues ::= ENUMERATED { gprsOnly(1), gprsAndImsi(3), attachResultValMAX(7) }
*/
typedef enum {
   TS24008IE_AttachResultValues_gprsOnly = 1,
   TS24008IE_AttachResultValues_gprsAndImsi = 3,
   TS24008IE_AttachResultValues_attachResultValMAX = 7
} TS24008IE_AttachResultValues;

EXTERN int NASEnc_TS24008IE_AttachResultValues (OSCTXT* pctxt
   , TS24008IE_AttachResultValues value);

EXTERN int NASDec_TS24008IE_AttachResultValues (OSCTXT* pctxt
   , TS24008IE_AttachResultValues* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_AttachResultValues (OSCTXT *pctxt, 
   const char* name, const TS24008IE_AttachResultValues* pvalue);

EXTERN extern const OSEnumItem TS24008IE_AttachResultValues_ENUMTAB[];
#define TS24008IE_AttachResultValues_ENUMTABSIZE 3

EXTERN const OSUTF8CHAR* TS24008IE_AttachResultValues_ToString (OSINT32 value);

EXTERN int TS24008IE_AttachResultValues_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_AttachResultValues* pvalue);

EXTERN int TS24008IE_AttachResultValues_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, 
      TS24008IE_AttachResultValues* pvalue);

EXTERN TS24008IE_AttachResultValues*
...
/**************************************************************/
/*
IntegrityTypes ::= ENUMERATED { gia4(0), gia5(1), gia6(2), gia7(3), integrityMAX(7) }
*/
typedef enum {
   TS24008IE_IntegrityTypes_gia4 = 0,
   TS24008IE_IntegrityTypes_gia5 = 1,
   TS24008IE_IntegrityTypes_gia6 = 2,
   TS24008IE_IntegrityTypes_gia7 = 3,
   TS24008IE_IntegrityTypes_integrityMAX = 7
} TS24008IE_IntegrityTypes;

EXTERN int NASEnc_TS24008IE_IntegrityTypes (OSCTXT* pctxt
   , TS24008IE_IntegrityTypes value);

EXTERN int NASDec_TS24008IE_IntegrityTypes (OSCTXT* pctxt
   , TS24008IE_IntegrityTypes* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_IntegrityTypes (OSCTXT *pctxt, 
   const char* name, const TS24008IE_IntegrityTypes* pvalue);

EXTERN extern const OSEnumItem TS24008IE_IntegrityTypes_ENUMTAB[];
#define TS24008IE_IntegrityTypes_ENUMTABSIZE 5

EXTERN const OSUTF8CHAR* TS24008IE_IntegrityTypes_ToString (OSINT32 value);

EXTERN int TS24008IE_IntegrityTypes_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_IntegrityTypes* pvalue);

EXTERN int TS24008IE_IntegrityTypes_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, TS24008IE_IntegrityTypes* pvalue)
      ;

EXTERN TS24008IE_IntegrityTypes*
    asn1Test_TS24008IE_IntegrityTypes (OSCTXT* pctxt);
...
typedef enum {
   ...
   TS24008IE_IdentityTypeValue_typeOfIdent_idTypeValueMAX = 7
...
#define TS24008IE_IdentityTypeValue_typeOfIdent_ENUMTABSIZE 6
...
IdentityTypeValue ::= SEQUENCE {
   spare [0] BOOLEAN DEFAULT FALSE,
   typeOfIdent [1] ENUMERATED { imsi(1), imei(2), imeisv(3), tmsi(4), p-tmsi(5), idTypeValueMAX(7) }
}
*/
...
/**************************************************************/
/*
UpdateResultValues ::= ENUMERATED { raUpdated(0), raLaUpdated(1), raUpdatedIsrActive(4), raLaUpdatedIsrActive(5), updateResultValMAX(7) }
*/
typedef enum {
   TS24008IE_UpdateResultValues_raUpdated = 0,
   TS24008IE_UpdateResultValues_raLaUpdated = 1,
   TS24008IE_UpdateResultValues_raUpdatedIsrActive = 4,
   TS24008IE_UpdateResultValues_raLaUpdatedIsrActive = 5,
   TS24008IE_UpdateResultValues_updateResultValMAX = 7
} TS24008IE_UpdateResultValues;

EXTERN int NASEnc_TS24008IE_UpdateResultValues (OSCTXT* pctxt
   , TS24008IE_UpdateResultValues value);

EXTERN int NASDec_TS24008IE_UpdateResultValues (OSCTXT* pctxt
   , TS24008IE_UpdateResultValues* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_UpdateResultValues (OSCTXT *pctxt, 
   const char* name, const TS24008IE_UpdateResultValues* pvalue);

EXTERN extern const OSEnumItem TS24008IE_UpdateResultValues_ENUMTAB[];
#define TS24008IE_UpdateResultValues_ENUMTABSIZE 5

EXTERN const OSUTF8CHAR* TS24008IE_UpdateResultValues_ToString (OSINT32 value);

EXTERN int TS24008IE_UpdateResultValues_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_UpdateResultValues* pvalue);

EXTERN int TS24008IE_UpdateResultValues_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, 
      TS24008IE_UpdateResultValues* pvalue);

EXTERN TS24008IE_UpdateResultValues*
...
/**************************************************************/
/*
UpdateTypeValues ::= ENUMERATED { raUpdating(0), raLaUpdating(1), raLaUpdatingImsiAttach(2), periodicUpdating(3), updateTypeValMAX(7) }
*/
typedef enum {
   TS24008IE_UpdateTypeValues_raUpdating = 0,
   TS24008IE_UpdateTypeValues_raLaUpdating = 1,
   TS24008IE_UpdateTypeValues_raLaUpdatingImsiAttach = 2,
   TS24008IE_UpdateTypeValues_periodicUpdating = 3,
   TS24008IE_UpdateTypeValues_updateTypeValMAX = 7
} TS24008IE_UpdateTypeValues;

EXTERN int NASEnc_TS24008IE_UpdateTypeValues (OSCTXT* pctxt
   , TS24008IE_UpdateTypeValues value);

EXTERN int NASDec_TS24008IE_UpdateTypeValues (OSCTXT* pctxt
   , TS24008IE_UpdateTypeValues* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_UpdateTypeValues (OSCTXT *pctxt, 
   const char* name, const TS24008IE_UpdateTypeValues* pvalue);

EXTERN extern const OSEnumItem TS24008IE_UpdateTypeValues_ENUMTAB[];
#define TS24008IE_UpdateTypeValues_ENUMTABSIZE 5

EXTERN const OSUTF8CHAR* TS24008IE_UpdateTypeValues_ToString (OSINT32 value);

EXTERN int TS24008IE_UpdateTypeValues_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_UpdateTypeValues* pvalue);

EXTERN int TS24008IE_UpdateTypeValues_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, 
      TS24008IE_UpdateTypeValues* pvalue);

EXTERN TS24008IE_UpdateTypeValues*
    asn1Test_TS24008IE_UpdateTypeValues (OSCTXT* pctxt);
...
/**************************************************************/
/*
ServiceTypeValues ::= ENUMERATED { signaling(0), data(1), pagingResp(2), multicast(3), broadcast(4), serviceTypeValMAX(7) }
*/
typedef enum {
   TS24008IE_ServiceTypeValues_signaling = 0,
   TS24008IE_ServiceTypeValues_data = 1,
   TS24008IE_ServiceTypeValues_pagingResp = 2,
   TS24008IE_ServiceTypeValues_multicast = 3,
   TS24008IE_ServiceTypeValues_broadcast = 4,
   TS24008IE_ServiceTypeValues_serviceTypeValMAX = 7
} TS24008IE_ServiceTypeValues;

EXTERN int NASEnc_TS24008IE_ServiceTypeValues (OSCTXT* pctxt
   , TS24008IE_ServiceTypeValues value);

EXTERN int NASDec_TS24008IE_ServiceTypeValues (OSCTXT* pctxt
   , TS24008IE_ServiceTypeValues* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_ServiceTypeValues (OSCTXT *pctxt, 
   const char* name, const TS24008IE_ServiceTypeValues* pvalue);

EXTERN extern const OSEnumItem TS24008IE_ServiceTypeValues_ENUMTAB[];
#define TS24008IE_ServiceTypeValues_ENUMTABSIZE 6

EXTERN const OSUTF8CHAR* TS24008IE_ServiceTypeValues_ToString (OSINT32 value);

EXTERN int TS24008IE_ServiceTypeValues_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_ServiceTypeValues* pvalue);

EXTERN int TS24008IE_ServiceTypeValues_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, 
      TS24008IE_ServiceTypeValues* pvalue);

EXTERN TS24008IE_ServiceTypeValues*
...
*/
typedef struct EXTERN TS24008IE_MsgAuthCode {
   OSOCTET data[4];
...
/**************************************************************/
/*
NSAPIValues ::= ENUMERATED { nsapi5(5), nsapi6(6), nsapi7(7), nsapi8(8), nsapi9(9), nsapi10(10), nsapi11(11), nsapi12(12), nsapi13(13), nsapi14(14), nsapi15(15) }
*/
typedef enum {
   TS24008IE_NSAPIValues_nsapi5 = 5,
   TS24008IE_NSAPIValues_nsapi6 = 6,
   TS24008IE_NSAPIValues_nsapi7 = 7,
   TS24008IE_NSAPIValues_nsapi8 = 8,
   TS24008IE_NSAPIValues_nsapi9 = 9,
   TS24008IE_NSAPIValues_nsapi10 = 10,
   TS24008IE_NSAPIValues_nsapi11 = 11,
   TS24008IE_NSAPIValues_nsapi12 = 12,
   TS24008IE_NSAPIValues_nsapi13 = 13,
   TS24008IE_NSAPIValues_nsapi14 = 14,
   TS24008IE_NSAPIValues_nsapi15 = 15
} TS24008IE_NSAPIValues;

EXTERN int NASEnc_TS24008IE_NSAPIValues (OSCTXT* pctxt
   , TS24008IE_NSAPIValues value);

EXTERN int NASDec_TS24008IE_NSAPIValues (OSCTXT* pctxt
   , TS24008IE_NSAPIValues* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_NSAPIValues (OSCTXT *pctxt, 
   const char* name, const TS24008IE_NSAPIValues* pvalue);

EXTERN extern const OSEnumItem TS24008IE_NSAPIValues_ENUMTAB[];
#define TS24008IE_NSAPIValues_ENUMTABSIZE 11

EXTERN const OSUTF8CHAR* TS24008IE_NSAPIValues_ToString (OSINT32 value);

EXTERN int TS24008IE_NSAPIValues_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_NSAPIValues* pvalue);

EXTERN int TS24008IE_NSAPIValues_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, TS24008IE_NSAPIValues* pvalue);

EXTERN TS24008IE_NSAPIValues* asn1Test_TS24008IE_NSAPIValues (OSCTXT* pctxt);
...
/**************************************************************/
/*
SAPIValues ::= ENUMERATED { unassigned(0), sapi3(3), sapi5(5), sapi9(9), sapi11(11), sapiMAX(15) }
*/
typedef enum {
   TS24008IE_SAPIValues_unassigned = 0,
   TS24008IE_SAPIValues_sapi3 = 3,
   TS24008IE_SAPIValues_sapi5 = 5,
   TS24008IE_SAPIValues_sapi9 = 9,
   TS24008IE_SAPIValues_sapi11 = 11,
   TS24008IE_SAPIValues_sapiMAX = 15
} TS24008IE_SAPIValues;

EXTERN int NASEnc_TS24008IE_SAPIValues (OSCTXT* pctxt
   , TS24008IE_SAPIValues value);

EXTERN int NASDec_TS24008IE_SAPIValues (OSCTXT* pctxt
   , TS24008IE_SAPIValues* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_SAPIValues (OSCTXT *pctxt, 
   const char* name, const TS24008IE_SAPIValues* pvalue);

EXTERN extern const OSEnumItem TS24008IE_SAPIValues_ENUMTAB[];
#define TS24008IE_SAPIValues_ENUMTABSIZE 6

EXTERN const OSUTF8CHAR* TS24008IE_SAPIValues_ToString (OSINT32 value);

EXTERN int TS24008IE_SAPIValues_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_SAPIValues* pvalue);

EXTERN int TS24008IE_SAPIValues_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, TS24008IE_SAPIValues* pvalue);

EXTERN TS24008IE_SAPIValues* asn1Test_TS24008IE_SAPIValues (OSCTXT* pctxt);

/**************************************************************/
/*                                                            */
/*  TFTPacketFilterComponentType                              */
/*                                                            */
/**************************************************************/
/*
TFTPacketFilterComponentType ::= ENUMERATED { ipv4Remote(16), ipv4Local(17), ipv6Remote(32), ipv6RemoteAddrPrefixLen(33), ipv6LocalAddrPrefixLen(35), protoIdNextHdr(48), singleLocalPort(64), localPortRange(65), singleRemotePort(80), remotePortRange(81), secParamIndex(96), typeOfSvcTrafficClass(112), flowLabel(128), typeMax(255), ... }
*/
typedef enum {
   TS24008IE_TFTPacketFilterComponentType_ipv4Remote = 16,
   TS24008IE_TFTPacketFilterComponentType_ipv4Local = 17,
   TS24008IE_TFTPacketFilterComponentType_ipv6Remote = 32,
   TS24008IE_TFTPacketFilterComponentType_ipv6RemoteAddrPrefixLen = 33,
   TS24008IE_TFTPacketFilterComponentType_ipv6LocalAddrPrefixLen = 35,
   TS24008IE_TFTPacketFilterComponentType_protoIdNextHdr = 48,
   TS24008IE_TFTPacketFilterComponentType_singleLocalPort = 64,
   TS24008IE_TFTPacketFilterComponentType_localPortRange = 65,
   TS24008IE_TFTPacketFilterComponentType_singleRemotePort = 80,
   TS24008IE_TFTPacketFilterComponentType_remotePortRange = 81,
   TS24008IE_TFTPacketFilterComponentType_secParamIndex = 96,
   TS24008IE_TFTPacketFilterComponentType_typeOfSvcTrafficClass = 112,
   TS24008IE_TFTPacketFilterComponentType_flowLabel = 128,
   TS24008IE_TFTPacketFilterComponentType_typeMax = 255,
   TS24008IE_TFTPacketFilterComponentType_UNKNOWN_
} TS24008IE_TFTPacketFilterComponentType;

EXTERN int NASEnc_TS24008IE_TFTPacketFilterComponentType (OSCTXT* pctxt
   , TS24008IE_TFTPacketFilterComponentType value);

EXTERN int NASDec_TS24008IE_TFTPacketFilterComponentType (OSCTXT* pctxt
   , TS24008IE_TFTPacketFilterComponentType* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_TFTPacketFilterComponentType (OSCTXT *pctxt, 
   const char* name, const TS24008IE_TFTPacketFilterComponentType* pvalue);

EXTERN extern const OSEnumItem TS24008IE_TFTPacketFilterComponentType_ENUMTAB[];
#define TS24008IE_TFTPacketFilterComponentType_ENUMTABSIZE 14

EXTERN const OSUTF8CHAR* TS24008IE_TFTPacketFilterComponentType_ToString (OSINT32 value);

EXTERN int TS24008IE_TFTPacketFilterComponentType_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_TFTPacketFilterComponentType* pvalue);

EXTERN int TS24008IE_TFTPacketFilterComponentType_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, 
      TS24008IE_TFTPacketFilterComponentType* pvalue);

EXTERN TS24008IE_TFTPacketFilterComponentType*
...
/**************************************************************/
/*
TFTParamId ::= ENUMERATED { authToken(1), flowId(2), packetFilterId(3), tftParamIdMax(255), ... }
*/
typedef enum {
   TS24008IE_TFTParamId_authToken = 1,
   TS24008IE_TFTParamId_flowId = 2,
   TS24008IE_TFTParamId_packetFilterId = 3,
   TS24008IE_TFTParamId_tftParamIdMax = 255,
   TS24008IE_TFTParamId_UNKNOWN_
} TS24008IE_TFTParamId;

EXTERN int NASEnc_TS24008IE_TFTParamId (OSCTXT* pctxt
   , TS24008IE_TFTParamId value);

EXTERN int NASDec_TS24008IE_TFTParamId (OSCTXT* pctxt
   , TS24008IE_TFTParamId* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_TFTParamId (OSCTXT *pctxt, 
   const char* name, const TS24008IE_TFTParamId* pvalue);

EXTERN extern const OSEnumItem TS24008IE_TFTParamId_ENUMTAB[];
#define TS24008IE_TFTParamId_ENUMTABSIZE 4

EXTERN const OSUTF8CHAR* TS24008IE_TFTParamId_ToString (OSINT32 value);

EXTERN int TS24008IE_TFTParamId_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_TFTParamId* pvalue);

EXTERN int TS24008IE_TFTParamId_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, TS24008IE_TFTParamId* pvalue);

EXTERN TS24008IE_TFTParamId* asn1Test_TS24008IE_TFTParamId (OSCTXT* pctxt);
...
/**************************************************************/
/*
ReqTypeValues ::= ENUMERATED { initialReq(1), handover(2), rlos(3), emergency(4), handoverEmerSvcs(6), reqTypeMAX(7) }
*/
typedef enum {
   TS24008IE_ReqTypeValues_initialReq = 1,
   TS24008IE_ReqTypeValues_handover = 2,
   TS24008IE_ReqTypeValues_rlos = 3,
   TS24008IE_ReqTypeValues_emergency = 4,
   TS24008IE_ReqTypeValues_handoverEmerSvcs = 6,
   TS24008IE_ReqTypeValues_reqTypeMAX = 7
} TS24008IE_ReqTypeValues;

EXTERN int NASEnc_TS24008IE_ReqTypeValues (OSCTXT* pctxt
   , TS24008IE_ReqTypeValues value);

EXTERN int NASDec_TS24008IE_ReqTypeValues (OSCTXT* pctxt
   , TS24008IE_ReqTypeValues* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_ReqTypeValues (OSCTXT *pctxt, 
   const char* name, const TS24008IE_ReqTypeValues* pvalue);

EXTERN extern const OSEnumItem TS24008IE_ReqTypeValues_ENUMTAB[];
#define TS24008IE_ReqTypeValues_ENUMTABSIZE 6

EXTERN const OSUTF8CHAR* TS24008IE_ReqTypeValues_ToString (OSINT32 value);

EXTERN int TS24008IE_ReqTypeValues_ToEnum (OSCTXT* pctxt,
   const OSUTF8CHAR* value, TS24008IE_ReqTypeValues* pvalue);

EXTERN int TS24008IE_ReqTypeValues_ToEnum2 (OSCTXT* pctxt,
   const OSUTF8CHAR* value, OSSIZE valueLen, TS24008IE_ReqTypeValues* pvalue);

EXTERN TS24008IE_ReqTypeValues*
    asn1Test_TS24008IE_ReqTypeValues (OSCTXT* pctxt);
...
*/
typedef struct EXTERN TS24008IE_RadioPriority {
   OSBOOL spare;
   OSUINT8 value;
} TS24008IE_RadioPriority;

EXTERN int NASEnc_TS24008IE_RadioPriority (OSCTXT* pctxt
   , TS24008IE_RadioPriority* pvalue);

EXTERN int NASDec_TS24008IE_RadioPriority (OSCTXT* pctxt
   , TS24008IE_RadioPriority* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_RadioPriority (OSCTXT *pctxt, 
   const char* name, const TS24008IE_RadioPriority* pvalue);

EXTERN TS24008IE_RadioPriority*
    asn1Test_TS24008IE_RadioPriority (OSCTXT* pctxt);

EXTERN int asn1Init_TS24008IE_RadioPriority (TS24008IE_RadioPriority* pvalue);
...
*/
typedef TS24008IE_RadioPriority TS24008IE_RadioPriority2;

EXTERN int NASEnc_TS24008IE_RadioPriority2 (OSCTXT* pctxt
   , TS24008IE_RadioPriority2* pvalue);

EXTERN int NASDec_TS24008IE_RadioPriority2 (OSCTXT* pctxt
   , TS24008IE_RadioPriority2* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_RadioPriority2 (OSCTXT *pctxt, 
   const char* name, const TS24008IE_RadioPriority2* pvalue);

EXTERN TS24008IE_RadioPriority2*
    asn1Test_TS24008IE_RadioPriority2 (OSCTXT* pctxt);

EXTERN int asn1Init_TS24008IE_RadioPriority2 (TS24008IE_RadioPriority2* pvalue);
...
BearerCapability ::= SEQUENCE {
   ...
   --<last3GExtElem/>
   octet3b [3] BearerCapOctet3bList OPTIONAL,
   --<first3GExtElem/>
   --<last3GExtElem/>
...
Cause ::= SEQUENCE {
   ...
   --<length fixed-size="0"/>
   --<noPresentBit/>
   diagnostics [4] OCTET STRING (SIZE (0..32)) OPTIONAL
}
*/
typedef struct EXTERN TS24008IE_Cause {
   struct {
      unsigned recommendationPresent : 1;
      unsigned diagnosticsPresent : 1;
   } m;
   OSUINT8 length;
...
UserUser ::= SEQUENCE {
   ...
   --<noPresentBit/>
   uuInfo [2] OCTET STRING OPTIONAL -- User-user info 
}
*/
typedef struct EXTERN TS24008IE_UserUser {
   struct {
      unsigned uuInfoPresent : 1;
   } m;
   OSUINT8 length;
   OSUINT8 uupd;
   OSDynOctStr uuInfo;
...
AttachResult ::= SEQUENCE {
   fop [0] BOOLEAN,
   resultOfAttach [1] AttachResultValues
}
*/
typedef struct EXTERN TS24008IE_AttachResult {
   OSBOOL fop;
   TS24008IE_AttachResultValues resultOfAttach;
...
ExtDRXParams ::= SEQUENCE {
   --<is3GLength/>
   length [0] INTEGER (1),
   pagingTimeWindow [1] INTEGER (0..15),
   eDRXValue [2] INTEGER (0..15)
}
*/
...
ExtQualityOfService ::= SEQUENCE {
   --<is3GLength/>
   length [0] INTEGER (0..255),
   maxBRUnit [1] INTEGER (0..255), -- BR = Bit rate 
   maxUplinkBR [2] INTEGER (0..65535),
   maxDownlinkBR [3] INTEGER (0..65535),
   guaranteedBRUnit [4] INTEGER (0..255),
   guaranteedUplinkBR [5] INTEGER (0..65535),
   guaranteedDownlinkBR [6] INTEGER (0..65535)
}
*/
...
IPv4Address ::= SEQUENCE {
   addr [0] OCTET STRING (SIZE (4)),
   mask [1] OCTET STRING (SIZE (4))
}
*/
typedef struct EXTERN TS24008IE_IPv4Address {
   OSOCTET addr[4];
   OSOCTET mask[4];
} TS24008IE_IPv4Address;

EXTERN int NASEnc_TS24008IE_IPv4Address (OSCTXT* pctxt
   , TS24008IE_IPv4Address* pvalue);

EXTERN int NASDec_TS24008IE_IPv4Address (OSCTXT* pctxt
   , TS24008IE_IPv4Address* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_IPv4Address (OSCTXT *pctxt, 
   const char* name, const TS24008IE_IPv4Address* pvalue);

EXTERN TS24008IE_IPv4Address* asn1Test_TS24008IE_IPv4Address (OSCTXT* pctxt);
...
IPv6Address ::= SEQUENCE {
   addr [0] OCTET STRING (SIZE (16)),
   mask [1] OCTET STRING (SIZE (16))
}
*/
typedef struct EXTERN TS24008IE_IPv6Address {
   OSOCTET addr[16];
   OSOCTET mask[16];
} TS24008IE_IPv6Address;

EXTERN int NASEnc_TS24008IE_IPv6Address (OSCTXT* pctxt
   , TS24008IE_IPv6Address* pvalue);

EXTERN int NASDec_TS24008IE_IPv6Address (OSCTXT* pctxt
   , TS24008IE_IPv6Address* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_IPv6Address (OSCTXT *pctxt, 
   const char* name, const TS24008IE_IPv6Address* pvalue);

EXTERN TS24008IE_IPv6Address* asn1Test_TS24008IE_IPv6Address (OSCTXT* pctxt);
...
IPv6AddressPrefix ::= SEQUENCE {
   addr [0] OCTET STRING (SIZE (16)),
   prefix [1] OCTET STRING (SIZE (1))
}
*/
typedef struct EXTERN TS24008IE_IPv6AddressPrefix {
   OSOCTET addr[16];
   OSOCTET prefix[1];
} TS24008IE_IPv6AddressPrefix;

EXTERN int NASEnc_TS24008IE_IPv6AddressPrefix (OSCTXT* pctxt
   , TS24008IE_IPv6AddressPrefix* pvalue);

EXTERN int NASDec_TS24008IE_IPv6AddressPrefix (OSCTXT* pctxt
   , TS24008IE_IPv6AddressPrefix* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_IPv6AddressPrefix (OSCTXT *pctxt, 
   const char* name, const TS24008IE_IPv6AddressPrefix* pvalue);

EXTERN TS24008IE_IPv6AddressPrefix*
...
/*
PortRange ::= SEQUENCE {
   low [0] INTEGER (0..65535),
   high [1] INTEGER (0..65535)
}
*/
typedef struct EXTERN TS24008IE_PortRange {
   OSUINT16 low;
   OSUINT16 high;
} TS24008IE_PortRange;

EXTERN int NASEnc_TS24008IE_PortRange (OSCTXT* pctxt
   , TS24008IE_PortRange* pvalue);

EXTERN int NASDec_TS24008IE_PortRange (OSCTXT* pctxt
   , TS24008IE_PortRange* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_PortRange (OSCTXT *pctxt, 
   const char* name, const TS24008IE_PortRange* pvalue);

EXTERN TS24008IE_PortRange* asn1Test_TS24008IE_PortRange (OSCTXT* pctxt);

/**************************************************************/
/*                                                            */
/*  TFTPacketFilterComponent                                  */
/*                                                            */
/**************************************************************/
/*
TFTPacketFilterComponent ::= SEQUENCE {
   id [0] TFTPacketFilterComponentType,
   --<inline/>
   value [1] EXPLICIT CHOICE {
      --<selector element="id" value="16"/>
      ipv4Remote [0] IPv4Address,
      --<selector element="id" value="17"/>
      ipv4Local [1] IPv4Address,
      --<selector element="id" value="32"/>
      ipv6Remote [2] IPv6Address,
      --<selector element="id" value="33"/>
      ipv6RemoteAddrPrefixLen [3] IPv6AddressPrefix,
      --<selector element="id" value="35"/>
      ipv6LocalAddrPrefixLen [4] IPv6AddressPrefix,
      --<selector element="id" value="48"/>
      protoIdNextHdr [5] INTEGER (0..255),
      --<selector element="id" value="64"/>
      singleLocalPort [6] INTEGER (0..65535),
      --<selector element="id" value="65"/>
      localPortRange [7] PortRange,
      --<selector element="id" value="80"/>
      singleRemotePort [8] INTEGER (0..65535),
      --<selector element="id" value="81"/>
      remotePortRange [9] PortRange,
      --<selector element="id" value="96"/>
      secParamIndex [10] INTEGER (0..4294967295), -- four octets
      --<selector element="id" value="112"/>
      typeOfSvcTrafficClass [11] SEQUENCE {
         class [0] INTEGER (0..255),
         mask [1] INTEGER (0..255)
      },
      --<selector element="id" value="128"/>
      flowLabel [12] SEQUENCE {
         spare [0] INTEGER (0..15), -- 4 bits
         label [1] INTEGER (0..1048575) -- 20 bits
      }
   }
}
*/
typedef struct EXTERN TS24008IE_TFTPacketFilterComponent {
   TS24008IE_TFTPacketFilterComponentType id;
   struct  {
      union {
         /* selector element = id, value = 16 */
         TS24008IE_IPv4Address ipv4Remote;
         /* selector element = id, value = 17 */
         TS24008IE_IPv4Address ipv4Local;
         /* selector element = id, value = 32 */
         TS24008IE_IPv6Address ipv6Remote;
         /* selector element = id, value = 33 */
         TS24008IE_IPv6AddressPrefix ipv6RemoteAddrPrefixLen;
         /* selector element = id, value = 35 */
         TS24008IE_IPv6AddressPrefix ipv6LocalAddrPrefixLen;
         /* selector element = id, value = 48 */
         OSUINT8 protoIdNextHdr;
         /* selector element = id, value = 64 */
         OSUINT16 singleLocalPort;
         /* selector element = id, value = 65 */
         TS24008IE_PortRange localPortRange;
         /* selector element = id, value = 80 */
         OSUINT16 singleRemotePort;
         /* selector element = id, value = 81 */
         TS24008IE_PortRange remotePortRange;
         /* selector element = id, value = 96 */
         OSUINT32 secParamIndex;
         /* selector element = id, value = 112 */
         struct EXTERN  {
            OSUINT8 class_;
            OSUINT8 mask;
...
EXTERN int NASEnc_TS24008IE_TFTPacketFilterComponent (OSCTXT* pctxt
   , TS24008IE_TFTPacketFilterComponent* pvalue);

EXTERN int NASDec_TS24008IE_TFTPacketFilterComponent (OSCTXT* pctxt
   , TS24008IE_TFTPacketFilterComponent* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_TFTPacketFilterComponent (OSCTXT *pctxt, 
   const char* name, const TS24008IE_TFTPacketFilterComponent* pvalue);

EXTERN TS24008IE_TFTPacketFilterComponent*
    asn1Test_TS24008IE_TFTPacketFilterComponent (OSCTXT* pctxt);

EXTERN int asn1Init_TS24008IE_TFTPacketFilterComponent (
   TS24008IE_TFTPacketFilterComponent* pvalue);

/**************************************************************/
/*                                                            */
/*  TFTPacketFilterContent                                    */
/*                                                            */
/**************************************************************/
/*
TFTPacketFilterContent ::= SEQUENCE {
   ...
   length [0] INTEGER (0..255),
   --<length fixed-size="0"/>
   components [1] SEQUENCE OF TFTPacketFilterComponent
}
*/
typedef struct EXTERN TS24008IE_TFTPacketFilterContent {
   OSUINT8 length;
   struct  {
      OSSIZE n;
      TS24008IE_TFTPacketFilterComponent *elem;
   } components;
} TS24008IE_TFTPacketFilterContent;

EXTERN int NASEnc_TS24008IE_TFTPacketFilterContent (OSCTXT* pctxt
   , TS24008IE_TFTPacketFilterContent* pvalue);

EXTERN int NASDec_TS24008IE_TFTPacketFilterContent (OSCTXT* pctxt
   , TS24008IE_TFTPacketFilterContent* pvalue);

EXTERN int asn1PrtToStrm_TS24008IE_TFTPacketFilterContent (OSCTXT *pctxt, 
   const char* name, const TS24008IE_TFTPacketFilterContent* pvalue);

EXTERN TS24008IE_TFTPacketFilterContent*
    asn1Test_TS24008IE_TFTPacketFilterContent (OSCTXT* pctxt);

EXTERN int asn1Init_TS24008IE_TFTPacketFilterContent (
   TS24008IE_TFTPacketFilterContent* pvalue);
...
TFTPacketFilterItem ::= SEQUENCE {
   ...
   contents [4] TFTPacketFilterContent
}
*/
typedef struct EXTERN TS24008IE_TFTPacketFilterItem {
   ...
   TS24008IE_TFTPacketFilterContent contents;
...
/*
TFTParam ::= SEQUENCE {
   paramIdentifier [0] TFTParamId,
   --<is3GLength/>
   length [1] INTEGER (0..255),
   --<inline/>
   contents [2] EXPLICIT CHOICE {
      --<selector element="paramIdentifier" value="1"/>
      --<length fixed-size="0">      
      authToken [0] OCTET STRING,
      --<selector element="paramIdentifier" value="2"/>
      flowId [1] SEQUENCE {
         mediaComponentNum [0] INTEGER (0..65535),
         ipFlowNum [1] INTEGER (0..65535)
      },
      --<selector element="paramIdentifier" value="3"/>
      --<length fixed-size="0">
      packetFilterIdList [2] OCTET STRING,
      --<length fixed-size="0">
      unknown [3] OCTET STRING
   }
}
*/
typedef struct EXTERN TS24008IE_TFTParam {
   TS24008IE_TFTParamId paramIdentifier;
   OSUINT8 length;
   struct  {
      union {
         /* selector element = paramIdentifier, value = 1 */
         OSDynOctStr authToken;
         /* selector element = paramIdentifier, value = 2 */
         struct EXTERN  {
            OSUINT16 mediaComponentNum;
            OSUINT16 ipFlowNum;
         } flowId;
         /* selector element = paramIdentifier, value = 3 */
         OSDynOctStr packetFilterIdList;
         /* default case */
         OSDynOctStr unknown;
      } u;
   } contents;
