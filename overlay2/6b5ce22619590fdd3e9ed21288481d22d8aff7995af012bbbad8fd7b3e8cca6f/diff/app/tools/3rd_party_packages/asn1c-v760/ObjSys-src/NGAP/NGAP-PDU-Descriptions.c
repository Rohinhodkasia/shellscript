...
void asn1SetTC_InitiatingMessage_uEContextResume
   (OSCTXT* pctxt, InitiatingMessage* pElem, UEContextResumeRequest *pvalue)
{
   pElem->procedureCode = 58;
   pElem->criticality = reject;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_uEContextResume;
   pElem->value.u.uEContextResume = pvalue;
}

void asn1SetTC_InitiatingMessage_uEContextSuspend
   (OSCTXT* pctxt, InitiatingMessage* pElem, UEContextSuspendRequest *pvalue)
{
   pElem->procedureCode = 59;
   pElem->criticality = reject;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_uEContextSuspend;
   pElem->value.u.uEContextSuspend = pvalue;
}
...
void asn1SetTC_InitiatingMessage_uERadioCapabilityIDMapping
   (OSCTXT* pctxt, InitiatingMessage* pElem, UERadioCapabilityIDMappingRequest *pvalue)
{
   pElem->procedureCode = 60;
   pElem->criticality = reject;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_uERadioCapabilityIDMapping;
   pElem->value.u.uERadioCapabilityIDMapping = pvalue;
}
...
void asn1SetTC_InitiatingMessage_aMFCPRelocationIndication
   (OSCTXT* pctxt, InitiatingMessage* pElem, AMFCPRelocationIndication *pvalue)
{
   pElem->procedureCode = 64;
   pElem->criticality = reject;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_aMFCPRelocationIndication;
   pElem->value.u.aMFCPRelocationIndication = pvalue;
}
...
void asn1SetTC_InitiatingMessage_connectionEstablishmentIndication
   (OSCTXT* pctxt, InitiatingMessage* pElem, ConnectionEstablishmentIndication *pvalue)
{
   pElem->procedureCode = 65;
   pElem->criticality = reject;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_connectionEstablishmentIndication;
   pElem->value.u.connectionEstablishmentIndication = pvalue;
}
...
void asn1SetTC_InitiatingMessage_downlinkRANEarlyStatusTransfer
   (OSCTXT* pctxt, InitiatingMessage* pElem, DownlinkRANEarlyStatusTransfer *pvalue)
{
   pElem->procedureCode = 63;
   pElem->criticality = ignore;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_downlinkRANEarlyStatusTransfer;
   pElem->value.u.downlinkRANEarlyStatusTransfer = pvalue;
}
...
void asn1SetTC_InitiatingMessage_downlinkRIMInformationTransfer
   (OSCTXT* pctxt, InitiatingMessage* pElem, DownlinkRIMInformationTransfer *pvalue)
{
   pElem->procedureCode = 54;
   pElem->criticality = ignore;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_downlinkRIMInformationTransfer;
   pElem->value.u.downlinkRIMInformationTransfer = pvalue;
}
...
void asn1SetTC_InitiatingMessage_handoverSuccess
   (OSCTXT* pctxt, InitiatingMessage* pElem, HandoverSuccess *pvalue)
{
   pElem->procedureCode = 61;
   pElem->criticality = ignore;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_handoverSuccess;
   pElem->value.u.handoverSuccess = pvalue;
}
...
void asn1SetTC_InitiatingMessage_rANCPRelocationIndication
   (OSCTXT* pctxt, InitiatingMessage* pElem, RANCPRelocationIndication *pvalue)
{
   pElem->procedureCode = 57;
   pElem->criticality = reject;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_rANCPRelocationIndication;
   pElem->value.u.rANCPRelocationIndication = pvalue;
}
...
void asn1SetTC_InitiatingMessage_retrieveUEInformation
   (OSCTXT* pctxt, InitiatingMessage* pElem, RetrieveUEInformation *pvalue)
{
   pElem->procedureCode = 55;
   pElem->criticality = reject;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_retrieveUEInformation;
   pElem->value.u.retrieveUEInformation = pvalue;
}
...
void asn1SetTC_InitiatingMessage_uEInformationTransfer
   (OSCTXT* pctxt, InitiatingMessage* pElem, UEInformationTransfer *pvalue)
{
   pElem->procedureCode = 56;
   pElem->criticality = reject;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_uEInformationTransfer;
   pElem->value.u.uEInformationTransfer = pvalue;
}
...
void asn1SetTC_InitiatingMessage_uplinkRANEarlyStatusTransfer
   (OSCTXT* pctxt, InitiatingMessage* pElem, UplinkRANEarlyStatusTransfer *pvalue)
{
   pElem->procedureCode = 62;
   pElem->criticality = reject;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_uplinkRANEarlyStatusTransfer;
   pElem->value.u.uplinkRANEarlyStatusTransfer = pvalue;
}
...
void asn1SetTC_InitiatingMessage_uplinkRIMInformationTransfer
   (OSCTXT* pctxt, InitiatingMessage* pElem, UplinkRIMInformationTransfer *pvalue)
{
   pElem->procedureCode = 53;
   pElem->criticality = ignore;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_uplinkRIMInformationTransfer;
   pElem->value.u.uplinkRIMInformationTransfer = pvalue;
}
...
void asn1SetTC_SuccessfulOutcome_uEContextResume
...
void asn1SetTC_SuccessfulOutcome_uEContextSuspend
...
void asn1SetTC_SuccessfulOutcome_uERadioCapabilityIDMapping
   (OSCTXT* pctxt, SuccessfulOutcome* pElem, UERadioCapabilityIDMappingResponse *pvalue)
{
   pElem->procedureCode = 60;
   pElem->criticality = reject;
   pElem->value.t = T_NGAP_PDU_Descriptions_NGAP_ELEMENTARY_PROCEDURES_uERadioCapabilityIDMapping;
...
void asn1SetTC_UnsuccessfulOutcome_uEContextResume
...
void asn1SetTC_UnsuccessfulOutcome_uEContextSuspend
