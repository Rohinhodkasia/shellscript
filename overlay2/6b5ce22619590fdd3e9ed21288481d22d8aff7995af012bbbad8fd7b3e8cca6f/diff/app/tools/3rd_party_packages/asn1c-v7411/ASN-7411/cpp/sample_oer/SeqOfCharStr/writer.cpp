...
int main (int argc, char** argv)
{
   ...
   ASN1T_SeqOfCharStr data;
   ASN1C_SeqOfCharStr SeqOfCharStrPDU (encodeBuffer, data);

   // Populate structure of generated type
   SeqOfCharStrPDU.genTestInstance();

   if (trace) {
      printf ("The following record will be encoded:\n");
      asn1Print_SeqOfCharStr ("data", &data);
      printf ("\n");
   }

   /* Encode */

   if ((stat = SeqOfCharStrPDU.Encode ()) == 0)
   {
      if (trace) {
