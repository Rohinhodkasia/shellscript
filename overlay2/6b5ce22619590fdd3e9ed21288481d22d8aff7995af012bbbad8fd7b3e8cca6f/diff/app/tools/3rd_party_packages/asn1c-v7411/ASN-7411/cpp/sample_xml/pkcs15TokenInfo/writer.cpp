...
int main (int argc, char** argv)
{
   ...
   pAlgorithmInfo = rtxMemAllocTypeZ (pctxt, ASN1T_AlgorithmInfo);
   pAlgorithmInfo->reference = 1;
   pAlgorithmInfo->algorithm = 1;
   pAlgorithmInfo->parameters.numocts = rtxUTF8LenBytes (msgbuf1);
   ...
   pAlgorithmInfo->parameters.numocts = rtxUTF8LenBytes (msgbuf2);
