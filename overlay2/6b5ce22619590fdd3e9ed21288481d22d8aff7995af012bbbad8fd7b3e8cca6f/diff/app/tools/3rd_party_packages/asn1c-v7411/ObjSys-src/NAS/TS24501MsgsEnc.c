...
EXTERN int NASEnc_TS24501Msg_SMPayloadContainer (OSCTXT* pctxt
...
*/
   ...
   ret = rtxEncBitsFromByteArray (pctxt, pvalue1->contents.data, pvalue1->contents.numocts * 8);
   ...
   , TS24501Msg_RegRequest* pvalue)
{
   ...
   if(!rtxCtxtTestFlag(pctxt, OSCONTCLOSED)){
      ...
      if (pvalue->m.containerPresent) {
         ...
         ret = NASEnc_TS24501Msg_PayloadContainer (pctxt, &pvalue->container);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24501Msg__SeqOfTS24501Msg_PLMNTechList* pvalue)
{
   ...
   for (i = 0; i < pvalue->n; i++) {
      ...
      ret = NASEnc_TS24501Msg_PLMNTechList (pctxt, &pvalue->elem[i]);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24501Msg_SORTransparentContainer* pvalue)
{
   ...
   ret = rtxEncBit (pctxt, pvalue->listType);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   ret = rtxEncBit (pctxt, pvalue->dataType);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   /* encode plmnIdTechList */

   RTXCTXTPUSHELEMNAME (pctxt, "plmnIdTechList");
   if (pvalue->m.plmnIdTechListPresent) {

      ret = NASEnc_TS24501Msg__SeqOfTS24501Msg_PLMNTechList (pctxt, &pvalue->
         plmnIdTechList);
      if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24501Msg_RequestType* pvalue)
{
   ...
   if (!(pvalue->reqType <= 7)) {
      rtxErrAddElemNameParm (pctxt);
      rtxErrAddIntParm (pctxt, (int)pvalue->reqType);
      return LOG_RTERR (pctxt, RTERR_CONSVIO);
   }

   RTDIAG_NEWBITFIELD (pctxt, "INTEGER");

   ret = rtxEncBits (pctxt, pvalue->reqType, 3);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24501Msg_DLNASTrans* pvalue)
{
   ...
   if (pvalue->containerType == 0x01) {
           ret = NASEnc_TS24501Msg_SMPayloadContainer (pctxt, &pvalue->container);
           if (ret < 0) return LOG_RTERR (pctxt, ret);
   } else {
	   ret = NASEnc_TS24501Msg_PayloadContainer (pctxt, &pvalue->container);
	   if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   , TS24501Msg_QOSFlowDescription* pvalue)
{
   ...
   ret = rtxEncBits (pctxt, pvalue->opCode, 3);
   if (ret < 0) return LOG_RTERR (pctxt, ret);
...
EXTERN int NASEnc_TS24501Msg_PDU (OSCTXT* pctxt, TS24501Msg_PDU* pvalue)
{
   ...
   switch (pvalue->protoDiscr)
   {
      ...
      case 46:
         ...
         ret = rtxEncUInt32 (pctxt, pvalue->hdrData.u.sm.pduSessIdent, 1);
         if (ret < 0) return LOG_RTERR (pctxt, ret);
   ...
   switch (pvalue->dataType)
   {
      ...
      case 2:
         ...
         if (pvalue->containerContents.u.locSvcsMsgContainer.m.addlInfoPresent) {
            ...
            ret = rtxEncUInt32 (pctxt, pvalue->containerContents.u.locSvcsMsgContainer.addlInfo.numocts, 1);
            if (ret < 0) return LOG_RTERR (pctxt, ret);
